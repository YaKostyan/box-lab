(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const H=5e4,T=1e3,wt=2,_t=1,Z=.5,f=[{id:"box-301",number:"301",name:"Самозбірна коробка №301",dimensions:{length:165,width:100,height:30},basePrice:5,sourceQuantity:1e3},{id:"box-302",number:"302",name:"Самозбірна коробка №302",dimensions:{length:130,width:130,height:50},basePrice:7,sourceQuantity:800},{id:"box-303",number:"303",name:"Самозбірна коробка №303",dimensions:{length:190,width:150,height:100},basePrice:17,sourceQuantity:800},{id:"box-304",number:"304",name:"Самозбірна коробка №304",dimensions:{length:230,width:150,height:35},basePrice:11,sourceQuantity:800},{id:"box-305",number:"305",name:"Самозбірна коробка №305",dimensions:{length:160,width:85,height:110},basePrice:6.5},{id:"box-306",number:"306",name:"Самозбірна коробка №306",dimensions:{length:145,width:145,height:40},basePrice:6.5,sourceQuantity:1e3},{id:"box-307",number:"307",name:"Самозбірна коробка №307",dimensions:{length:280,width:180,height:100},basePrice:18,sourceQuantity:500},{id:"box-308",number:"308",name:"Самозбірна коробка №308",dimensions:{length:250,width:180,height:40},basePrice:12,sourceQuantity:800},{id:"box-309",number:"309",name:"Самозбірна коробка №309",dimensions:{length:210,width:150,height:50},basePrice:11,sourceQuantity:900},{id:"box-310",number:"310",name:"Самозбірна коробка №310",dimensions:{length:260,width:260,height:50},basePrice:15,sourceQuantity:600},{id:"box-311",number:"311",name:"Самозбірна коробка №311",dimensions:{length:370,width:170,height:100},basePrice:17},{id:"box-101",number:"101",name:"Самозбірна коробка №101",dimensions:{length:178,width:115,height:48},basePrice:4,sourceQuantity:800}],St=[{question:"Як відбувається доставка?",answer:"Відправляємо замовлення по Україні. Місто, відділення або адресний формат менеджер погоджує з вами під час підтвердження заявки."},{question:"Які строки виготовлення?",answer:"Строк залежить від розміру коробки, тиражу та завантаження виробництва. Менеджер називає точну дату до запуску замовлення."},{question:"Що отримує постійний клієнт?",answer:"Після підтвердження менеджером у кабінеті активується персональна ціна. Вона автоматично відображається в каталозі, калькуляторі та кошику."},{question:"Як проходить оплата?",answer:"Форму оплати, рахунок і підсумкову суму менеджер погоджує з вами до початку виготовлення."},{question:"Чи працюєте ви з малим і великим бізнесом?",answer:"Так. Можна почати з невеликої партії або замовити регулярний великий тираж. Калькулятор рахує до 50 000 коробок, більший обсяг прораховує менеджер."},{question:"Чи робите коробки під індивідуальний запит?",answer:"Так. Якщо серед готових розмірів немає потрібного, вкажіть габарити й особливості замовлення в коментарі. Менеджер уточнить деталі та підготує розрахунок."}];function u(t){return new Intl.NumberFormat("uk-UA",{style:"currency",currency:"UAH",minimumFractionDigits:Number.isInteger(t)?0:2,maximumFractionDigits:2}).format(t)}function q(t,e){return t.basePrice+(e>=T?_t:wt)}function P(t,e,a){return a?.partner?t.basePrice+Math.min(Math.max(a.fixedMarkup,0),.99):q(t,e)}function ct(t){const{length:e,width:a,height:n}=t.dimensions;return e*a*n}function xt(t,e){const a=[t.length,t.width,t.height].sort((s,o)=>o-s),n=[e.length,e.width,e.height].sort((s,o)=>o-s);return a.every((s,o)=>s<=n[o])}const h={accounts:"toffipacks-accounts-v3",orders:"toffipacks-orders-v3",session:"toffipacks-session-v3",cart:"toffipacks-cart-v1"},lt=new Date().toISOString(),ht=[{id:"account-admin",name:"Адміністратор ToffiPacks",phone:"+380000000001",company:"ToffiPacks",password:"admin123",role:"admin",partner:!1,fixedMarkup:Z,createdAt:lt},{id:"account-partner",name:"Постійний клієнт",phone:"+380671112233",company:"",password:"client123",role:"client",partner:!0,fixedMarkup:Z,createdAt:lt}],gt=[];function et(t,e){try{const a=localStorage.getItem(t);return a?JSON.parse(a):e}catch{return e}}function v(t,e){localStorage.setItem(t,JSON.stringify(e))}function Lt(){localStorage.getItem(h.accounts)||v(h.accounts,ht),localStorage.getItem(h.orders)||v(h.orders,gt),localStorage.getItem(h.cart)||v(h.cart,[])}Lt();let C="box-101",d=500,at="",tt="size",I=null,dt,A=null;const bt=document.querySelector("#app");if(!bt)throw new Error("Root element #app was not found.");function N(){return et(h.accounts,ht)}function W(){return et(h.orders,gt).map(e=>{if("items"in e&&Array.isArray(e.items))return e;const a=e;return{id:a.id,createdAt:a.createdAt,customerName:a.customerName,phone:a.phone,company:a.company,comment:a.comment,items:[{productId:a.productId,productNumber:a.productNumber,dimensions:a.dimensions,quantity:a.quantity,unitPrice:a.unitPrice,total:a.total,priceType:a.priceType}],total:a.total,accountId:a.accountId,status:a.status}})}function Q(){return et(h.cart,[]).filter(t=>f.some(e=>e.id===t.productId)&&t.quantity>0)}function x(){const t=localStorage.getItem(h.session);return N().find(e=>e.id===t)??null}function nt(){return f.find(t=>t.id===C)??f[0]}function B(t){return Number.isFinite(t)?Math.min(H,Math.max(1,Math.round(t))):1}function st(t){let e=t.replace(/\D/g,"");return e.length===10&&e.startsWith("0")&&(e=`38${e}`),e.length===12&&e.startsWith("380")?`+${e}`:t.trim()}function K(t){return st(t).replace(/\D/g,"")}function m(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function w(t){return`${t.length} × ${t.width} × ${t.height} мм`}function it(t){const e=t%100,a=t%10;return e>=11&&e<=14?`${t} позицій`:a===1?`${t} позиція`:a>=2&&a<=4?`${t} позиції`:`${t} позицій`}function X(t,e){return e?.partner?"Фіксована ціна клієнта":t>=T?"Оптова ціна":"Роздрібна ціна"}function j(t,e=!1){const{length:a,width:n,height:s}=t.dimensions,o=170+Math.min(100,a/3),i=58+Math.min(54,s/2.5),r=50+Math.min(44,n/4),c=72,l=e?70:82,p=l-r*.55,g=c+o,y=g+r,b=l+i;return`
    <svg class="box-visual${e?" box-visual--compact":""}" viewBox="0 0 470 270" role="img"
      aria-label="Схема коробки ${m(t.number)}, ${w(t.dimensions)}">
      <g class="box-visual__shape">
        <polygon class="box-visual__top" points="${c},${l} ${c+r},${p} ${y},${p} ${g},${l}" />
        <polygon class="box-visual__side" points="${g},${l} ${y},${p} ${y},${p+i} ${g},${b}" />
      ...
      <g class="dimension-line dimension-line--length">
        <line x1="${c}" y1="${b+28}" x2="${g}" y2="${b+28}" />
  ...
  `}function ut(){return f.map(t=>`<option value="${t.id}"${t.id===C?" selected":""}>№${t.number} · ${w(t.dimensions)}</option>`).join("")}function Tt(){const t=nt();return`
    ...
    <main id="main">
      <section class="hero section">
        ...
        <div class="hero-calculator reveal" aria-label="Швидкий розрахунок">
          ...
          <label class="field">
            <span>Коробка</span>
            <select class="select" id="hero-product-select">${ut()}</select>
          </label>
          <label class="field">
            <span>Кількість</span>
            <input class="input" id="hero-quantity-input" type="number" min="1" max="${H}" value="${d}" />
          </label>
          <div class="hero-calculator__result">
            <span id="hero-price-label">Роздрібна ціна</span>
            <strong id="hero-total">${u(q(t,d)*d)}</strong>
            <small id="hero-unit">${u(q(t,d))} / шт.</small>
          </div>
        ...
        <div class="calculator-shell reveal">
          ...
          <div class="calculator-card">
            ...
            <label class="field">
              ...
              <select class="select select--large" id="calculator-product-select">${ut()}</select>
            </label>
            <div class="calculator-preview" id="calculator-preview">${j(t,!0)}</div>
            <div class="quantity-block">
              ...
              <div class="quantity-control">
                ...
                <input id="quantity-input" type="number" min="1" max="${H}" value="${d}" />
            ...
            <div class="calculation-result" aria-live="polite">
              <div>
                ...
                <strong id="calculator-unit-price">${u(q(t,d))}<small>/ шт.</small></strong>
              </div>
              <div class="calculation-result__total">
                <span>Весь тираж</span>
                <strong id="calculator-total">${u(q(t,d)*d)}</strong>
              </div>
            </div>
  ...
  `}bt.innerHTML=Tt();const z=document.querySelector("#product-grid"),Y=document.querySelector("#catalog-count");function At(t){const e=x(),a=q(t,1),n=q(t,T),s=e?.partner?P(t,1,e):null;return`
    <article
      class="product-card${t.id===C?" is-selected":""}"
      data-open-product="${t.id}"
      tabindex="0"
      role="button"
      aria-label="Відкрити коробку №${t.number}, ${w(t.dimensions)}"
    >
      <div class="product-card__head">
        <span class="product-card__number">№${t.number}</span>
        <span class="product-card__size-label">внутрішній розмір</span>
      </div>
      <div class="product-card__visual">${j(t,!0)}</div>
      <h3>${w(t.dimensions)}</h3>
  ...
  `}function kt(t){const e=x(),a=P(t,d,e),n=a*d;return`
    <div class="product-modal">
      <div class="product-modal__visual">
        <div class="product-modal__labels">
          <span>№${t.number}</span>
        </div>
        <div class="product-modal__drawing">${j(t,!0)}</div>
        <p>Внутрішній розмір · Д × Ш × В</p>
      </div>
      <div class="product-modal__content">
        <p class="eyebrow"><span></span> Внутрішній розмір</p>
        <h2 id="product-dialog-title">${w(t.dimensions)}</h2>

        <div class="product-modal__rules">
          <div><span>1–999 шт.</span><strong>${u(q(t,1))} / шт.</strong></div>
          <div><span>від 1 000 шт.</span><strong>${u(q(t,T))} / шт.</strong></div>
        </div>
        ...
        <div class="quantity-block quantity-block--modal">
          ...
          <div class="quantity-control">
            <button type="button" data-quantity-step="-100" aria-label="Зменшити кількість на 100">−</button>
            <input id="modal-quantity-input" type="number" min="1" max="${H}" value="${d}" />
            <button type="button" data-quantity-step="100" aria-label="Збільшити кількість на 100">+</button>
          </div>
        ...
        <div class="product-modal__total" aria-live="polite">
          <div><span id="modal-price-tier">${X(d,e)}</span><strong id="modal-unit-price">${u(a)} / шт.</strong></div>
  ...
  `}function vt(){const t=document.querySelector("#product-dialog");if(!t?.open||!A)return;const e=f.find(l=>l.id===A);if(!e)return;const a=x(),n=P(e,d,a),s=t.querySelector("#modal-quantity-input");s&&(s.value=String(d));const o=t.querySelector("#modal-quantity-output");o&&(o.value=`${d.toLocaleString("uk-UA")} шт.`);const i=t.querySelector("#modal-price-tier");i&&(i.textContent=X(d,a));const r=t.querySelector("#modal-unit-price");r&&(r.textContent=`${u(n)} / шт.`);const c=t.querySelector("#modal-total");c&&(c.textContent=u(n*d)),t.querySelectorAll("[data-quantity]").forEach(l=>{l.classList.toggle("is-active",Number(l.dataset.quantity)===d)})}function ft(t){const e=f.find(s=>s.id===t),a=document.querySelector("#product-dialog"),n=document.querySelector("#product-dialog-content");!e||!a||!n||(A=e.id,ot(e.id),n.innerHTML=kt(e),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""),vt())}function Pt(){const t=at.trim().toLocaleLowerCase("uk-UA");return f.filter(a=>{const n=`${a.number} ${a.name} ${w(a.dimensions)}`.toLocaleLowerCase("uk-UA"),s=!t||n.includes(t),o=!I||xt(I,a.dimensions);return s&&o}).sort((a,n)=>tt==="price"?a.basePrice-n.basePrice:tt==="number"?Number(a.number)-Number(n.number):ct(a)-ct(n))}function _(t=!1){if(!z||!Y)return;if(t){Y.textContent="Оновлюємо список…",z.innerHTML=Array.from({length:6},()=>'<div class="product-skeleton" aria-hidden="true"><i></i><i></i><i></i></div>').join("");return}const e=Pt(),a=I?` · предмет ${w(I)}`:"";if(Y.textContent=`${e.length} із ${f.length} розмірів${a}`,!e.length){z.innerHTML=`
    ...
    `;return}z.innerHTML=e.map(At).join("")}function G(){window.clearTimeout(dt),_(!0),dt=window.setTimeout(()=>_(!1),320)}function k(){const t=nt(),e=x(),a=P(t,d,e),n=a*d,s=X(d,e);document.querySelectorAll("#calculator-product-select, #hero-product-select").forEach(L=>{L.value=t.id}),document.querySelectorAll("#quantity-input, #hero-quantity-input, #modal-quantity-input").forEach(L=>{L.value=String(d)});const o=document.querySelector("#quantity-output");o&&(o.value=`${d.toLocaleString("uk-UA")} шт.`);const i=document.querySelector("#calculator-preview");i&&(i.classList.remove("is-changing"),i.offsetWidth,i.classList.add("is-changing"),i.innerHTML=j(t,!0));const r=document.querySelector("#calculator-tier");r&&(r.textContent=s);const c=document.querySelector("#calculator-unit-price");c&&(c.innerHTML=`${u(a)}<small>/ шт.</small>`);const l=document.querySelector("#calculator-total");l&&(l.textContent=u(n));const p=document.querySelector("#hero-price-label");p&&(p.textContent=s);const g=document.querySelector("#hero-total");g&&(g.textContent=u(n));const y=document.querySelector("#hero-unit");y&&(y.textContent=`${u(a)} / шт.`);const b=document.querySelector("#account-price-badge");b&&(b.textContent=e?.partner?"Персональна ціна активна":"Публічна ціна",b.classList.toggle("is-partner",!!e?.partner));const V=document.querySelector("#threshold-note");if(V)if(e?.partner)V.innerHTML=`<strong>Фіксована ціна:</strong> ${u(a)} за одиницю незалежно від тиражу.`;else if(d<T){const L=T-d,qt=q(t,T)*T;V.innerHTML=`Ще <strong>${L.toLocaleString("uk-UA")} шт.</strong> до оптового тарифу. 1000 шт. коштуватимуть ${u(qt)}.`}else V.innerHTML=`<strong>Оптовий тариф активний.</strong> Економія проти роздрібної ціни — ${u(d)} на всьому тиражі.`;document.querySelectorAll("[data-quantity]").forEach(L=>{L.classList.toggle("is-active",Number(L.dataset.quantity)===d)}),U(),vt()}function ot(t,e=!1){f.some(a=>a.id===t)&&(C=t,_(!1),k(),e&&document.querySelector("#calculator")?.scrollIntoView({behavior:"smooth",block:"start"}))}function O(t){d=B(t),k()}function pt(t,e){if(!f.some(o=>o.id===t))return;const a=Q(),n=a.find(o=>o.productId===t);n?n.quantity=B(e):a.push({productId:t,quantity:B(e)}),v(h.cart,a),U();const s=document.querySelector("#cart-button");s?.classList.remove("is-updated"),s?.offsetWidth,s?.classList.add("is-updated")}function Et(t,e){const a=Q(),n=a.find(s=>s.productId===t);n&&(n.quantity=B(e),v(h.cart,a),U())}function Mt(t){v(h.cart,Q().filter(e=>e.productId!==t)),U()}function U(){const t=document.querySelector("#request-summary"),e=document.querySelector("#cart-count"),a=document.querySelector('#request-form button[type="submit"]'),n=Q(),s=x();if(e&&(e.textContent=String(n.length)),a&&(a.disabled=n.length===0),!t)return;if(!n.length){t.innerHTML=`
    ...
    `;return}let o=0;const i=n.map(r=>{const c=f.find(g=>g.id===r.productId);if(!c)return"";const l=P(c,r.quantity,s),p=l*r.quantity;return o+=p,`
        <article class="cart-item">
          <div class="cart-item__index">№${c.number}</div>
          <div class="cart-item__info">
            <strong>${w(c.dimensions)}</strong>
            <span>${u(l)} / шт.</span>
          </div>
          <label class="cart-item__quantity">
            <span>Кількість</span>
            <input class="input" type="number" min="1" max="${H}" value="${r.quantity}" data-cart-quantity="${c.id}" />
          </label>
    ...
    <div class="cart-summary__total">
      <span>${it(n.length)}</span>
      <div><small>Загальна вартість</small><strong>${u(o)}</strong></div>
    </div>
    <a class="cart-continue" href="#catalog">+ Додати ще один розмір</a>
  `}function F(){const t=document.querySelector("#account-button"),e=x();if(!t)return;t.textContent=e?e.name.split(" ")[0]:"Кабінет",t.classList.toggle("is-signed-in",!!e);const a=document.querySelector("#request-account-hint");a&&(a.textContent=e?e.name:"Гість");const n=document.querySelector("#request-form");if(n&&e){const s=(o,i)=>{const r=n.elements.namedItem(o);r instanceof HTMLInputElement&&!r.value&&(r.value=i)};s("name",e.name),s("phone",e.phone),s("company",e.company)}U()}function Ct(){const t=x();if(t){const e=W().filter(r=>r.accountId===t.id).slice().reverse(),a=e.filter(r=>r.status!=="Закрита").length,n=e.reduce((r,c)=>r+c.total,0),s=t.name.split(/\s+/).filter(Boolean).slice(0,2).map(r=>r[0]).join("").toLocaleUpperCase("uk-UA"),o=nt(),i=P(o,d,t);return`
        ...
        <div class="account-dashboard__grid">
              ...
              ${e.length?e.map(r=>{const c=r.items.reduce((l,p)=>l+p.quantity,0);return`
                          <article class="account-order">
                            <div class="account-order__main">
                              <strong>${it(r.items.length)}</strong>
          ...
          <aside class="account-sidebar">
            <article class="account-quick-order">
              ...
              <div class="account-quick-order__box">${j(o,!1)}</div>
              <span>Коробка №${o.number}</span>
              <h3>${w(o.dimensions)}</h3>
  ...
  `}function R(){const t=document.querySelector("#account-page-content");t&&(t.innerHTML=Ct())}function yt(t,e,a){const n=t.querySelector("[data-auth-status]");n&&(n.textContent=e,n.className=`form-status is-${a}`)}function It(t,e){const a=K(t),n=N().find(s=>K(s.phone)===a&&s.password===e);return n?(localStorage.setItem(h.session,n.id),n):null}function mt(t,e=!1){if(t.classList.add("was-validated"),!t.reportValidity())return;const a=new FormData(t),n=It(String(a.get("phone")??""),String(a.get("password")??""));if(!n||e&&n.role!=="admin"){yt(t,e?"Потрібен акаунт менеджера.":"Невірний телефон або пароль.","error");return}F(),k(),_(!1),e?E():(R(),window.location.hash="account")}function Nt(t){if(t.classList.add("was-validated"),!t.reportValidity())return;const e=new FormData(t),a=st(String(e.get("phone")??"")),n=N();if(n.some(o=>K(o.phone)===K(a))){yt(t,"Акаунт із таким номером уже існує.","error");return}const s={id:`account-${Date.now().toString(36)}`,name:String(e.get("name")??"").trim(),phone:a,company:String(e.get("company")??"").trim(),password:String(e.get("password")??""),role:"client",partner:!1,fixedMarkup:Z,createdAt:new Date().toISOString()};n.push(s),v(h.accounts,n),localStorage.setItem(h.session,s.id),F(),k(),_(!1),R(),window.location.hash="account"}function Dt(t){const e=document.querySelector("#request-status"),a=Q();if(!a.length){e&&(e.className="form-status is-error",e.textContent="Додайте хоча б одну коробку до кошика.");return}if(t.classList.add("was-validated"),!t.reportValidity()){e&&(e.className="form-status is-error",e.textContent="Перевірте обов’язкові поля та згоду.");return}const n=new FormData(t),s=x(),o=a.flatMap(l=>{const p=f.find(y=>y.id===l.productId);if(!p)return[];const g=P(p,l.quantity,s);return[{productId:p.id,productNumber:p.number,dimensions:p.dimensions,quantity:l.quantity,unitPrice:g,total:g*l.quantity,priceType:X(l.quantity,s)}]}),i=o.reduce((l,p)=>l+p.total,0),r={id:`TP-${Date.now().toString(36).toUpperCase()}`,createdAt:new Date().toISOString(),customerName:String(n.get("name")??"").trim(),phone:st(String(n.get("phone")??"")),company:String(n.get("company")??"").trim(),comment:String(n.get("comment")??"").trim(),items:o,total:i,accountId:s?.id,status:"Нова"},c=W();c.push(r),v(h.orders,c),v(h.cart,[]),U(),R(),e&&(e.className="form-status is-success",e.innerHTML=`<strong>Заявку створено.</strong><span>${it(r.items.length)} на суму ${u(r.total)}.</span>`),t.querySelector('button[type="submit"]')?.focus()}function Ut(t){return["Нова","У роботі","Уточнення","Підтверджена","Закрита"].map(a=>`<option value="${a}"${a===t?" selected":""}>${a}</option>`).join("")}function E(){const t=document.querySelector("#admin-content");if(!t)return;const e=x();if(!e||e.role!=="admin"){t.innerHTML=`
    ...
    `;return}const a=W().slice().reverse(),n=N().filter(i=>i.role==="client"),s=a.filter(i=>i.status!=="Закрита").length,o=a.reduce((i,r)=>i+r.total,0);t.innerHTML=`
          ...
          ${a.length?a.map(i=>`
                      <article class="order-card">
                        <div class="order-card__top">
                          ...
                          <select class="select status-select" data-order-status="${m(i.id)}">${Ut(i.status)}</select>
                        </div>
  ...
  `}function rt(){const t=document.querySelector("#admin-page"),e=document.querySelector("#account-page"),a=document.querySelector("#main"),n=document.querySelector(".site-header"),s=document.querySelector(".site-footer"),o=document.querySelector(".demo-strip"),i=window.location.hash==="#admin",r=window.location.hash==="#account";t&&(t.hidden=!i),e&&(e.hidden=!r),a&&(a.hidden=i||r),n&&(n.hidden=i||r),s&&(s.hidden=i||r),o&&(o.hidden=i||r),document.body.classList.toggle("is-admin",i),document.body.classList.toggle("is-account",r),i?(E(),window.scrollTo({top:0})):r&&(R(),window.scrollTo({top:0}))}function Ht(){const t=document.querySelectorAll(".reveal");if(!("IntersectionObserver"in window)){t.forEach(a=>a.classList.add("is-visible"));return}const e=new IntersectionObserver(a=>{a.forEach(n=>{n.isIntersecting&&(n.target.classList.add("is-visible"),e.unobserve(n.target))})},{threshold:.12});t.forEach(a=>e.observe(a))}document.querySelector("#menu-button")?.addEventListener("click",t=>{const e=t.currentTarget,a=document.querySelector("#site-nav"),n=e.getAttribute("aria-expanded")!=="true";e.setAttribute("aria-expanded",String(n)),a?.classList.toggle("is-open",n)});document.querySelectorAll(".site-nav a").forEach(t=>{t.addEventListener("click",()=>{document.querySelector("#site-nav")?.classList.remove("is-open"),document.querySelector("#menu-button")?.setAttribute("aria-expanded","false")})});document.querySelector('.site-header .brand[href="#top"]')?.addEventListener("click",t=>{t.preventDefault(),window.location.hash!=="#top"&&(window.history.pushState(null,"","#top"),rt()),window.scrollTo({top:0,behavior:window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})});document.querySelector("#fit-form")?.addEventListener("submit",t=>{t.preventDefault();const e=t.currentTarget;e.classList.add("was-validated");const a=document.querySelector("#fit-message");if(!e.reportValidity()){a&&(a.textContent="Вкажіть три додатні розміри.",a.className="form-message is-error");return}const n=new FormData(e);I={length:Number(n.get("length")),width:Number(n.get("width")),height:Number(n.get("height"))},a&&(a.textContent="Розміри застосовано. Показуємо коробки нижче.",a.className="form-message is-success"),G(),window.setTimeout(()=>document.querySelector("#catalog")?.scrollIntoView({behavior:"smooth"}),180)});document.querySelector("#catalog-search")?.addEventListener("input",t=>{at=t.currentTarget.value,G()});const S=document.querySelector("#catalog-sort"),M=S?.querySelector(".catalog-sort__trigger"),D=S?.querySelector(".catalog-sort__menu"),$=Array.from(S?.querySelectorAll("[data-sort-value]")??[]);function J(t=!1){!M||!D||(M.setAttribute("aria-expanded","false"),D.hidden=!0,S?.classList.remove("is-open"),t&&M.focus())}function $t(){!M||!D||(M.setAttribute("aria-expanded","true"),D.hidden=!1,S?.classList.add("is-open"))}function Ot(t){const e=$.find(n=>n.dataset.sortValue===t),a=document.querySelector("#catalog-sort-value");!e||!S||!a||(tt=t,S.dataset.value=t,a.textContent=e.querySelector("span")?.textContent??e.textContent,$.forEach(n=>{n.setAttribute("aria-selected",String(n===e))}),J(!0),G())}M?.addEventListener("click",()=>{D?.hidden?$t():J()});$.forEach(t=>{t.addEventListener("click",()=>{Ot(t.dataset.sortValue)})});S?.addEventListener("keydown",t=>{const e=$.indexOf(document.activeElement),a=$.findIndex(s=>s.getAttribute("aria-selected")==="true");if(t.key==="Escape"){t.preventDefault(),J(!0);return}if(t.key!=="ArrowDown"&&t.key!=="ArrowUp"&&t.key!=="Home"&&t.key!=="End")return;t.preventDefault(),D?.hidden&&$t();let n=e>=0?e:a;t.key==="Home"&&(n=0),t.key==="End"&&(n=$.length-1),t.key==="ArrowDown"&&(n=(n+1)%$.length),t.key==="ArrowUp"&&(n=(n-1+$.length)%$.length),$[n]?.focus()});document.addEventListener("click",t=>{S?.contains(t.target)||J()});document.querySelector("#reset-catalog")?.addEventListener("click",()=>{I=null,at="";const t=document.querySelector("#catalog-search");t&&(t.value="");const e=document.querySelector("#fit-message");e&&(e.textContent=""),G()});document.querySelector("#calculator-product-select")?.addEventListener("change",t=>{ot(t.currentTarget.value)});document.querySelector("#hero-product-select")?.addEventListener("change",t=>{ot(t.currentTarget.value)});document.querySelector("#quantity-input")?.addEventListener("input",t=>{O(Number(t.currentTarget.value))});document.querySelector("#hero-quantity-input")?.addEventListener("input",t=>{O(Number(t.currentTarget.value))});document.querySelector("#request-form")?.addEventListener("submit",t=>{t.preventDefault(),Dt(t.currentTarget)});document.addEventListener("click",t=>{const e=t.target,a=e.closest("[data-open-product]");if(a?.dataset.openProduct){ft(a.dataset.openProduct);return}const n=e.closest("[data-quantity]");if(n?.dataset.quantity){O(Number(n.dataset.quantity));return}const s=e.closest("[data-quantity-step]");if(s?.dataset.quantityStep){O(d+Number(s.dataset.quantityStep));return}if(e.closest("[data-product-to-cart]")){pt(A??C,d),document.querySelector("#product-dialog")?.close(),A=null;return}if(e.closest("[data-add-selected-to-cart]")){pt(C,d);return}const o=e.closest("[data-remove-cart]");if(o?.dataset.removeCart){Mt(o.dataset.removeCart);return}if(e.closest("[data-product-to-calculator]")){document.querySelector("#product-dialog")?.close(),A=null,window.location.hash="calculator",document.querySelector("#calculator")?.scrollIntoView({behavior:"smooth",block:"start"});return}const i=e.closest("[data-close-dialog]");if(i){i.closest("dialog")?.close(),A=null;return}const r=e.closest("[data-auth-tab]");if(r?.dataset.authTab){const c=r.closest(".auth-forms");c?.querySelectorAll("[data-auth-tab]").forEach(l=>{const p=l.dataset.authTab===r.dataset.authTab;l.classList.toggle("is-active",p),l.setAttribute("aria-selected",String(p))}),c?.querySelectorAll("[data-auth-panel]").forEach(l=>{l.hidden=l.dataset.authPanel!==r.dataset.authTab});return}if(e.closest("#logout-button")){localStorage.removeItem(h.session),F(),k(),_(!1),R();return}e.closest("#admin-logout")&&(localStorage.removeItem(h.session),F(),k(),_(!1),E())});document.addEventListener("input",t=>{const e=t.target;e instanceof HTMLInputElement&&e.id==="modal-quantity-input"&&O(Number(e.value))});document.addEventListener("keydown",t=>{if(t.key!=="Enter"&&t.key!==" ")return;const e=t.target;!(e instanceof HTMLElement)||!e.matches(".product-card")||(t.preventDefault(),e.dataset.openProduct&&ft(e.dataset.openProduct))});document.addEventListener("submit",t=>{const e=t.target;e instanceof HTMLFormElement&&(e.id==="login-form"?(t.preventDefault(),mt(e)):e.id==="register-form"?(t.preventDefault(),Nt(e)):e.id==="admin-login-form"&&(t.preventDefault(),mt(e,!0)))});document.addEventListener("change",t=>{const e=t.target;if(e instanceof HTMLInputElement||e instanceof HTMLSelectElement){if(e instanceof HTMLInputElement&&e.dataset.cartQuantity){Et(e.dataset.cartQuantity,Number(e.value));return}if(e instanceof HTMLSelectElement&&e.dataset.orderStatus){const a=W(),n=a.find(s=>s.id===e.dataset.orderStatus);n&&(n.status=e.value,v(h.orders,a),E());return}if(e instanceof HTMLInputElement&&e.dataset.partnerToggle){const a=N(),n=a.find(s=>s.id===e.dataset.partnerToggle);n&&(n.partner=e.checked,v(h.accounts,a),E());return}if(e instanceof HTMLInputElement&&e.dataset.partnerMarkup){const a=N(),n=a.find(s=>s.id===e.dataset.partnerMarkup);n&&(n.fixedMarkup=Math.min(.99,Math.max(0,Number(e.value)||0)),v(h.accounts,a),E())}}});document.querySelector("#product-dialog")?.addEventListener("click",t=>{t.target===t.currentTarget&&(t.currentTarget.close(),A=null)});window.addEventListener("hashchange",rt);_(!0);window.setTimeout(()=>_(!1),460);k();F();rt();Ht();
