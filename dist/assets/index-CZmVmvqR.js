(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const Xe={},Kt="toffipacks-api-session-v1",Ge=Xe,Ae=String(Ge?.VITE_API_BASE_URL??"").trim().replace(/\/$/,""),L=!!Ae;class Tt extends Error{status;code;constructor(e,a,n="request_error"){super(a),this.status=e,this.code=n}}function rt(){localStorage.removeItem(Kt)}function ft(){return!!localStorage.getItem(Kt)}async function I(t,e={}){if(!L)throw new Tt(0,"Backend API is not configured.","api_disabled");const a=localStorage.getItem(Kt),n=await fetch(`${Ae}${t}`,{...e,headers:{Accept:"application/json",...e.body?{"Content-Type":"application/json"}:{},...a?{Authorization:`Bearer ${a}`}:{},...e.headers}}),s=await n.json().catch(()=>({}));if(!n.ok)throw n.status===401&&rt(),new Tt(n.status,s.error?.message??"Сервер не зміг виконати запит.",s.error?.code);return s}async function be(t,e){const a=await I(t,{method:"POST",body:JSON.stringify(e)});return localStorage.setItem(Kt,a.token),a.account}const k={products:async()=>(await I("/api/products")).products,login:(t,e)=>be("/api/auth/login",{phone:t,password:e}),register:t=>be("/api/auth/register",t),me:async()=>(await I("/api/auth/me")).account,updateMe:async t=>(await I("/api/auth/me",{method:"PATCH",body:JSON.stringify(t)})).account,logout:async()=>{try{await I("/api/auth/logout",{method:"POST"})}finally{rt()}},createOrder:async t=>(await I("/api/orders",{method:"POST",body:JSON.stringify(t)})).order,myOrders:async()=>(await I("/api/me/orders")).orders,adminProducts:async()=>(await I("/api/admin/products")).products,createProduct:async t=>(await I("/api/admin/products",{method:"POST",body:JSON.stringify(t)})).product,updateProduct:async(t,e)=>(await I(`/api/admin/products/${encodeURIComponent(t)}`,{method:"PATCH",body:JSON.stringify(e)})).product,deleteProduct:t=>I(`/api/admin/products/${encodeURIComponent(t)}`,{method:"DELETE"}),resetProducts:async()=>(await I("/api/admin/products/reset",{method:"POST"})).products,adminOrders:async()=>(await I("/api/admin/orders")).orders,updateOrder:async(t,e)=>(await I(`/api/admin/orders/${encodeURIComponent(t)}`,{method:"PATCH",body:JSON.stringify(e)})).order,deleteOrder:t=>I(`/api/admin/orders/${encodeURIComponent(t)}`,{method:"DELETE"}),adminClients:async()=>(await I("/api/admin/clients")).clients,updateClient:async(t,e)=>(await I(`/api/admin/clients/${encodeURIComponent(t)}`,{method:"PATCH",body:JSON.stringify(e)})).client,backup:()=>I("/api/admin/backup")},Mt=5e4,z=1e3,ta=2,ea=1,Ct=.5,Jt=[{id:"box-301",number:"301",name:"Самозбірна коробка №301",dimensions:{length:165,width:100,height:30},basePrice:5,sourceQuantity:1e3},{id:"box-302",number:"302",name:"Самозбірна коробка №302",dimensions:{length:130,width:130,height:50},basePrice:7,sourceQuantity:800},{id:"box-303",number:"303",name:"Самозбірна коробка №303",dimensions:{length:190,width:150,height:100},basePrice:17,sourceQuantity:800},{id:"box-304",number:"304",name:"Самозбірна коробка №304",dimensions:{length:230,width:150,height:35},basePrice:11,sourceQuantity:800},{id:"box-305",number:"305",name:"Самозбірна коробка №305",dimensions:{length:160,width:85,height:110},basePrice:6.5},{id:"box-306",number:"306",name:"Самозбірна коробка №306",dimensions:{length:145,width:145,height:40},basePrice:6.5,sourceQuantity:1e3},{id:"box-307",number:"307",name:"Самозбірна коробка №307",dimensions:{length:280,width:180,height:100},basePrice:18,sourceQuantity:500},{id:"box-308",number:"308",name:"Самозбірна коробка №308",dimensions:{length:250,width:180,height:40},basePrice:12,sourceQuantity:800},{id:"box-309",number:"309",name:"Самозбірна коробка №309",dimensions:{length:210,width:150,height:50},basePrice:11,sourceQuantity:900},{id:"box-310",number:"310",name:"Самозбірна коробка №310",dimensions:{length:260,width:260,height:50},basePrice:15,sourceQuantity:600},{id:"box-311",number:"311",name:"Самозбірна коробка №311",dimensions:{length:370,width:170,height:100},basePrice:17},{id:"box-101",number:"101",name:"Самозбірна коробка №101",dimensions:{length:178,width:115,height:48},basePrice:4,sourceQuantity:800}],aa=[{question:"Як відбувається доставка?",answer:"Доставляємо по Києву та Київській області. Формат, точну адресу й вартість потрібно уточнити з менеджером під час підтвердження заявки."},{question:"Які строки виготовлення?",answer:"Строк залежить від розміру коробки, тиражу та завантаження виробництва. Менеджер називає точну дату до запуску замовлення."},{question:"Що отримує постійний клієнт?",answer:"Після підтвердження менеджером у кабінеті активується персональна ціна. Вона автоматично відображається в каталозі, калькуляторі та кошику."},{question:"Як проходить оплата?",answer:"Форму оплати, рахунок і підсумкову суму менеджер погоджує з вами до початку виготовлення."},{question:"Чи працюєте ви з малим і великим бізнесом?",answer:"Так. Можна почати з невеликої партії або замовити регулярний великий тираж. Калькулятор рахує до 50 000 коробок, більший обсяг прораховує менеджер."},{question:"Чи робите коробки під індивідуальний запит?",answer:"Так. Якщо серед готових розмірів немає потрібного, вкажіть габарити й особливості замовлення в коментарі. Менеджер уточнить деталі та підготує розрахунок."}],Le=[{id:"find-size",question:"Як підібрати розмір?",answer:"Введіть довжину, ширину та висоту предмета. Сайт порівняє всі три сторони й покаже найкомпактніші коробки, у які він поміститься.",actionLabel:"Підібрати коробку",actionHref:"#fit"},{id:"calculate-price",question:"Як дізнатися ціну?",answer:"Оберіть коробку та вкажіть кількість від 1 до 50 000 штук. Калькулятор одразу покаже ціну за одиницю та за весь тираж.",actionLabel:"Розрахувати ціну",actionHref:"#calculator"},{id:"delivery",question:"Як працює доставка?",answer:"Доставляємо по Києву та Київській області. Формат, адресу й вартість менеджер погоджує під час підтвердження заявки.",actionLabel:"Умови доставки",actionHref:"#delivery"},{id:"lead-time",question:"Які строки виготовлення?",answer:"Строк залежить від розміру, тиражу та завантаження виробництва. Точну дату менеджер назве до запуску замовлення.",actionLabel:"Залишити заявку",actionHref:"#request"},{id:"personal-price",question:"Де побачити мої ціни?",answer:"Увійдіть до кабінету за номером телефону. Якщо менеджер призначив персональні ціни, вони автоматично з’являться в кабінеті, каталозі, калькуляторі та кошику.",actionLabel:"Відкрити кабінет",actionHref:"#account"},{id:"custom-size",question:"Немає потрібного розміру?",answer:"Опишіть потрібні габарити, кількість та особливості у коментарі до заявки. Менеджер уточнить деталі й підготує окремий розрахунок.",actionLabel:"Описати запит",actionHref:"#request"}];function y(t){return new Intl.NumberFormat("uk-UA",{style:"currency",currency:"UAH",minimumFractionDigits:Number.isInteger(t)?0:2,maximumFractionDigits:2}).format(t)}function D(t,e){return t.basePrice+(e>=z?ea:ta)}function vt(t,e,a){const n=ot(t,a);return n!==null?n:D(t,e)}function ot(t,e){if(!e?.partner)return null;const a=Number(e.productPrices?.[t.id]);return Number.isFinite(a)&&a>0?a:null}function Vt(t){const{length:e,width:a,height:n}=t.dimensions;return e*a*n}function Wt(t,e,a=0){const n=[t.length,t.width,t.height].sort((u,o)=>o-u),s=[e.length,e.width,e.height].sort((u,o)=>o-u),i=n.map((u,o)=>(s[o]-u)/2),r=i.map(u=>Math.max(0,a-u));return{fits:r.every(u=>u===0),clearancesPerSide:i,deficitsPerSide:r}}const f={accounts:"toffipacks-accounts-v3",orders:"toffipacks-orders-v3",session:"toffipacks-session-v3",cart:"toffipacks-cart-v1",products:"toffipacks-products-v1",fit:"toffipacks-fit-v1",measurements:"toffipacks-measurements-v1"},Pe=/^[\p{L}\p{N}._-]+$/u,Et=new Date().toISOString(),Te=()=>Object.fromEntries(Jt.map(t=>[t.id,Math.round((t.basePrice+Ct)*100)/100])),Me=[{id:"account-admin",name:"Адміністратор ToffiPacks",phone:"+380000000001",company:"ToffiPacks",password:"admin123",role:"admin",partner:!1,fixedMarkup:Ct,productPrices:{},createdAt:Et},{id:"account-partner",name:"Постійний клієнт",phone:"+380671112233",company:"",password:"client123",role:"client",partner:!0,fixedMarkup:Ct,productPrices:Te(),createdAt:Et}],Ce=[];function yt(t,e){try{const a=localStorage.getItem(t);return a?JSON.parse(a):e}catch{return e}}function v(t,e){localStorage.setItem(t,JSON.stringify(e))}function na(){localStorage.getItem(f.accounts)||v(f.accounts,Me),localStorage.getItem(f.orders)||v(f.orders,Ce),localStorage.getItem(f.cart)||v(f.cart,[]),localStorage.getItem(f.products)||v(f.products,Jt.map(t=>({...t,active:!0,updatedAt:Et})))}na();L&&(v(f.accounts,[]),v(f.orders,[]),ft()||localStorage.removeItem(f.session));const Ee=yt(f.fit,null),qt=Ee?.dimensions,sa=qt&&[qt.length,qt.width,qt.height].every(t=>Number.isFinite(t)&&t>0),ne=Ee?.margin;let tt="box-101",S=500,Ot="",ie="size",X=!1,x=sa?qt:null,M=ne===5||ne===10?ne:0,ve,gt=null,le="",lt="all",ue="",Rt="Усі",A="",P="",kt="",q="";const it=new Set;let re="",oe;const Ie=document.querySelector("#app");if(!Ie)throw new Error("Root element #app was not found.");function K(){return yt(f.accounts,Me).map(t=>({...t,productPrices:t.productPrices&&typeof t.productPrices=="object"?t.productPrices:t.partner?Te():{}}))}function O(){const t=Jt.map(e=>({...e,active:!0,updatedAt:Et}));return yt(f.products,t).filter(e=>e&&typeof e.id=="string"&&typeof e.number=="string"&&Number.isFinite(e.basePrice)&&Number.isFinite(e.dimensions?.length)&&Number.isFinite(e.dimensions?.width)&&Number.isFinite(e.dimensions?.height)).map(e=>({...e,active:e.active!==!1,updatedAt:e.updatedAt||Et}))}function C(){return O().filter(t=>t.active)}function F(t){v(f.products,t)}function Z(){return yt(f.orders,Ce).map(e=>{if("items"in e&&Array.isArray(e.items))return{...e,statusHistory:Array.isArray(e.statusHistory)&&e.statusHistory.length?e.statusHistory:[{status:e.status,at:e.createdAt}]};const a=e;return{id:a.id,createdAt:a.createdAt,customerName:a.customerName,phone:a.phone,company:a.company,comment:a.comment,items:[{productId:a.productId,productNumber:a.productNumber,dimensions:a.dimensions,quantity:a.quantity,unitPrice:a.unitPrice,total:a.total,priceType:a.priceType}],total:a.total,accountId:a.accountId,status:a.status,statusHistory:[{status:a.status,at:a.createdAt}]}})}function W(){const t=C();return yt(f.cart,[]).filter(e=>t.some(a=>a.id===e.productId)&&e.quantity>0)}function V(){const t=localStorage.getItem(f.session);return K().find(e=>e.id===t)??null}function Nt(t){const e={...t},a=K().filter(n=>n.id!==t.id&&n.role!==t.role);return v(f.accounts,[e,...a]),localStorage.setItem(f.session,e.id),e}function ia(t,e,a,n){v(f.accounts,[t,...e]),v(f.orders,a),F(n),localStorage.setItem(f.session,t.id)}async function Qt(){if(!L||!ft())return null;try{const t=await k.me();if(t.role==="admin"){const[e,a,n]=await Promise.all([k.adminClients(),k.adminOrders(),k.adminProducts()]);ia(t,e,a,n)}else{const[e,a]=await Promise.all([k.myOrders(),k.products()]);Nt(t),v(f.orders,e),F(a)}return t}catch(t){if(t instanceof Tt&&t.status===401)return rt(),localStorage.removeItem(f.session),null;throw t}}function $t(){const t=C();return t.find(e=>e.id===tt)??t[0]}function It(t){return Number.isFinite(t)?Math.min(Mt,Math.max(1,Math.round(t))):1}function nt(){return yt(f.measurements,[]).filter(t=>t&&typeof t.id=="string"&&[t.dimensions?.length,t.dimensions?.width,t.dimensions?.height].every(e=>Number.isFinite(e)&&Number(e)>0)&&[0,5,10].includes(t.margin))}function ct(t){return t===0?"без додаткового запасу":`+${t} мм з кожного боку`}function De(){const t=nt();return t.length?`
  ...
  `}function Ue(){return C().slice().sort((t,e)=>t.number.localeCompare(e.number,"uk-UA",{numeric:!0})).map(t=>`<button class="product-picker__option" type="button" role="option" data-product-picker-value="${c(t.id)}" aria-selected="${t.id===tt}">
    ...
    <main id="main">
      <section class="hero section">
        ...
        <div class="hero-calculator reveal" aria-label="Швидкий розрахунок">
          ...
          <label class="field">
            <span>Кількість</span>
            <input class="input" id="hero-quantity-input" type="number" min="1" max="${Mt}" value="${S}" />
          </label>
          ...
          <form class="fit-form" id="fit-form" novalidate>
            ...
            <fieldset class="fit-margin">
              ...
              <div class="fit-margin__options">
                ${[0,5,10].map(e=>`
                      <label>
                        <input type="radio" name="fitMargin" value="${e}"${M===e?" checked":""} />
          ...
          <div class="calculator-card">
            ...
            <div class="quantity-block">
              ...
              <div class="quantity-control">
                ...
                <input id="quantity-input" type="number" min="1" max="${Mt}" value="${S}" />
  ...
  `}Ie.innerHTML=ca();function da(){const t=document.querySelector("#support-panel"),e=document.querySelector("#support-trigger");!t||!e||!t.hidden||(t.hidden=!1,e.setAttribute("aria-expanded","true"),e.setAttribute("aria-label","Закрити помічника Тофіка"),window.requestAnimationFrame(()=>{t.classList.add("is-open"),t.querySelector("[data-support-topic]")?.focus({preventScroll:!0})}))}function Ut(t=!0){const e=document.querySelector("#support-panel"),a=document.querySelector("#support-trigger");!e||!a||e.hidden||(e.classList.remove("is-open"),a.setAttribute("aria-expanded","false"),a.setAttribute("aria-label","Відкрити помічника Тофіка"),window.setTimeout(()=>{e.classList.contains("is-open")||(e.hidden=!0)},240),t&&a.focus({preventScroll:!0}))}function la(t){const e=Le.find(s=>s.id===t),a=document.querySelector("#support-conversation"),n=document.querySelector("#support-panel");!e||!a||!n||(re=e.id,window.clearTimeout(oe),n.classList.add("has-answer","is-thinking"),document.querySelectorAll("[data-support-topic]").forEach(s=>{const i=s.dataset.supportTopic===e.id;s.classList.toggle("is-active",i),s.setAttribute("aria-pressed",String(i))}),a.innerHTML=`
    <div class="support-answer-stage">
      <div class="support-answer-question"><span>${c(e.question)}</span></div>
      <div class="support-message support-message--bot support-message--typing" aria-label="Тофік готує відповідь">
        <i></i><i></i><i></i>
      </div>
    </div>
  `,oe=window.setTimeout(()=>{re===e.id&&(n.classList.remove("is-thinking"),a.innerHTML=`
      <div class="support-answer-stage">
        <div class="support-answer-question"><span>${c(e.question)}</span></div>
    ...
    `)},460))}function ua(){const t=document.querySelector("#support-panel"),e=document.querySelector("#support-conversation");!t||!e||(window.clearTimeout(oe),re="",t.classList.remove("has-answer","is-thinking"),e.innerHTML=He(),document.querySelectorAll("[data-support-topic]").forEach(a=>{a.classList.remove("is-active"),a.setAttribute("aria-pressed","false")}),window.setTimeout(()=>document.querySelector("[data-support-topic]")?.focus({preventScroll:!0}),80))}const Ft=document.querySelector("#product-grid"),se=document.querySelector("#catalog-count");function ce(t){return new Intl.NumberFormat("uk-UA",{maximumFractionDigits:1}).format(Math.max(0,t))}function pa(t){if(!x)return"";const e=Wt(x,t.dimensions,M);if(e.fits){const n=Math.min(...e.clearancesPerSide);return`<div class="product-card__fit"><strong>Підходить</strong><span>мін. ${ce(n)} мм на бік</span></div>`}const a=Math.max(...e.deficitsPerSide)*2;return`<div class="product-card__fit is-near"><strong>Найближчий розмір</strong><span>бракує до ${ce(a)} мм</span></div>`}function ma(t){if(!x)return"";const e=Wt(x,t.dimensions,M);if(e.fits)return`<div class="product-modal__fit is-fit"><strong>Коробка підходить</strong><span>${ct(M)} враховано у підборі.</span></div>`;const a=Math.max(...e.deficitsPerSide)*2;return`<div class="product-modal__fit is-warning" role="status"><strong>Цей розмір замалий</strong><span>Бракує до ${ce(a)} мм для обраного запасу. Додайте лише після ручної перевірки.</span></div>`}function $e(t){const e=V(),a=D(t,1),n=D(t,z),s=ot(t,e);return`
    <article
  ...
  `}function fa(t){const e=V(),a=vt(t,S,e),n=a*S;return`
    <div class="product-modal">
      ...
      <div class="product-modal__content">
        ...
        <div class="quantity-block quantity-block--modal">
          ...
          <div class="quantity-control">
            <button type="button" data-quantity-step="-100" aria-label="Зменшити кількість на 100">−</button>
            <input id="modal-quantity-input" type="number" min="1" max="${Mt}" value="${S}" />
            <button type="button" data-quantity-step="100" aria-label="Збільшити кількість на 100">+</button>
          </div>
  ...
  `}function Fe(){const t=document.querySelector("#product-dialog");if(!t?.open||!gt)return;const e=C().find(l=>l.id===gt);if(!e)return;const a=V(),n=vt(e,S,a),s=t.querySelector("#modal-quantity-input");s&&(s.value=String(S));const i=t.querySelector("#modal-quantity-output");i&&(i.value=`${S.toLocaleString("uk-UA")} шт.`);const r=t.querySelector("#modal-price-tier");r&&(r.textContent=Yt(S,a,e));const u=t.querySelector("#modal-unit-price");u&&(u.textContent=`${y(n)} / шт.`);const o=t.querySelector("#modal-total");o&&(o.textContent=y(n*S)),t.querySelectorAll("[data-quantity]").forEach(l=>{l.classList.toggle("is-active",Number(l.dataset.quantity)===S)})}function we(t){const e=C().find(s=>s.id===t),a=document.querySelector("#product-dialog"),n=document.querySelector("#product-dialog-content");!e||!a||!n||(gt=e.id,Re(e.id),n.innerHTML=fa(e),a.classList.remove("is-closing"),typeof a.showModal=="function"?a.showModal():a.setAttribute("open",""),Fe())}function xt(t){const e=document.querySelector("#product-dialog");if(!e){gt=null,t?.();return}const a=()=>{e.classList.remove("is-closing"),e.open&&typeof e.close=="function"?e.close():e.removeAttribute("open"),gt=null,t?.()};if(!e.open||window.matchMedia("(prefers-reduced-motion: reduce)").matches){a();return}e.classList.contains("is-closing")||(e.classList.add("is-closing"),window.setTimeout(a,230))}function ga(){const t=C(),e=Ot.trim().toLocaleLowerCase("uk-UA");return t.filter(n=>{const s=`${n.number} ${n.name} ${E(n.dimensions)}`.toLocaleLowerCase("uk-UA"),i=!e||s.includes(e),r=!x||Wt(x,n.dimensions,M).fits;return i&&r}).sort((n,s)=>ie==="price"?n.basePrice-s.basePrice:ie==="number"?n.number.localeCompare(s.number,"uk-UA",{numeric:!0}):Vt(n)-Vt(s))}function ha(){if(!x)return[];const t=Ot.trim().toLocaleLowerCase("uk-UA");return C().filter(e=>{const a=`${e.number} ${e.name} ${E(e.dimensions)}`.toLocaleLowerCase("uk-UA");return!t||a.includes(t)}).map(e=>{const n=Wt(x,e.dimensions,M).deficitsPerSide.reduce((s,i)=>s+i,0);return{product:e,deficit:n}}).sort((e,a)=>e.deficit-a.deficit||Vt(e.product)-Vt(a.product)).slice(0,3).map(({product:e})=>e)}function N(t=!1){if(!Ft||!se)return;const e=document.querySelector("#catalog-more"),a=document.querySelector("#catalog-more-button");if(t){se.textContent="Оновлюємо список…",e&&(e.hidden=!0),Ft.innerHTML=Array.from({length:6},()=>'<div class="product-skeleton" aria-hidden="true"><i></i><i></i><i></i></div>').join("");return}const n=ga(),s=x?` · предмет ${E(x)} · ${ct(M)}`:"";if(se.textContent=`${n.length} із ${C().length} розмірів${s}`,!n.length){const o=ha();Ft.innerHTML=`
      <div class="empty-state${o.length?" empty-state--nearest":""}">
        ...
        <p>${M?`Із запасом ${ct(M)} точного варіанта немає. Найближчі коробки нижче замалі — це позначено окремо.`:"Змініть габарити предмета або залиште заявку з потрібним розміром."}</p>
        <div class="empty-state__actions">
          ${M?'<button class="button button--ghost" type="button" data-use-tight-fit>Показати без запасу</button>':""}
    ...
    `,e&&(e.hidden=!0);return}const r=window.matchMedia("(max-width: 680px)").matches&&!Ot.trim()&&!x&&n.length>4,u=r&&!X?n.slice(0,4):n;Ft.innerHTML=u.map($e).join(""),e&&a&&(e.hidden=!r,a.textContent=X?"Згорнути каталог":`Показати всі ${n.length} розмірів`,a.setAttribute("aria-expanded",String(X)))}function St(){window.clearTimeout(ve),N(!0),ve=window.setTimeout(()=>N(!1),320)}function je(t=!1){const e=$t();document.querySelectorAll("[data-product-picker]").forEach(a=>{a.dataset.value=e.id;const n=a.querySelector(".product-picker__value b"),s=a.querySelector(".product-picker__value span");n&&(n.textContent=`№${e.number}`),s&&(s.textContent=E(e.dimensions));const i=a.querySelector(".product-picker__menu");i&&t&&(i.innerHTML=Ue()),a.querySelectorAll("[data-product-picker-value]").forEach(r=>{r.setAttribute("aria-selected",String(r.dataset.productPickerValue===e.id))})})}function ut(t,e=!1){const a=t.querySelector("[data-product-picker-trigger]"),n=t.querySelector(".product-picker__menu");t.classList.remove("is-open"),a?.setAttribute("aria-expanded","false"),window.setTimeout(()=>{n&&!t.classList.contains("is-open")&&(n.hidden=!0)},190),e&&a?.focus()}function Be(t){document.querySelectorAll("[data-product-picker].is-open").forEach(e=>{e!==t&&ut(e)})}function Ve(t,e=!1){Be(t);const a=t.querySelector("[data-product-picker-trigger]"),n=t.querySelector(".product-picker__menu");!a||!n||(n.hidden=!1,a.setAttribute("aria-expanded","true"),window.requestAnimationFrame(()=>{t.classList.add("is-open");const s=t.querySelector('[data-product-picker-value][aria-selected="true"]');s?.scrollIntoView({block:"nearest"}),e&&s?.focus()}))}function ba(t){t.classList.contains("is-open")?ut(t):Ve(t)}function j(){const t=$t(),e=V(),a=vt(t,S,e),n=a*S,s=Yt(S,e,t);je(),document.querySelectorAll("#quantity-input, #hero-quantity-input, #modal-quantity-input").forEach(T=>{T.value=String(S)});const i=document.querySelector("#quantity-output");i&&(i.value=`${S.toLocaleString("uk-UA")} шт.`);const r=document.querySelector("#calculator-preview");r&&(r.classList.remove("is-changing"),r.offsetWidth,r.classList.add("is-changing"),r.innerHTML=wt(t,!0));const u=document.querySelector("#calculator-tier");u&&(u.textContent=s);const o=document.querySelector("#calculator-unit-price");o&&(o.innerHTML=`${y(a)}<small>/ шт.</small>`);const l=document.querySelector("#calculator-total");l&&(l.textContent=y(n));const g=document.querySelector("#hero-price-label");g&&(g.textContent=s);const d=document.querySelector("#hero-total");d&&(d.textContent=y(n));const m=document.querySelector("#hero-unit");m&&(m.textContent=`${y(a)} / шт.`);const h=document.querySelector("#account-price-badge");if(h){const T=ot(t,e)!==null;h.textContent=T?"Персональна ціна активна":"Публічна ціна",h.classList.toggle("is-partner",T)}const $=document.querySelector("#threshold-note");if($)if(ot(t,e)!==null)$.innerHTML=`<strong>Ваша персональна ціна:</strong> ${y(a)} за одиницю незалежно від тиражу.`;else if(S<z){const T=z-S,R=D(t,z)*z;$.innerHTML=`Ще <strong>${T.toLocaleString("uk-UA")} шт.</strong> до оптового тарифу. 1000 шт. коштуватимуть ${y(R)}.`}else $.innerHTML=`<strong>Оптовий тариф активний.</strong> Економія проти роздрібної ціни — ${y(S)} на всьому тиражі.`;document.querySelectorAll("[data-quantity]").forEach(T=>{T.classList.toggle("is-active",Number(T.dataset.quantity)===S)}),G(),Fe()}function Re(t,e=!1){C().some(a=>a.id===t)&&(tt=t,N(!1),j(),e&&document.querySelector("#calculator")?.scrollIntoView({behavior:"smooth",block:"start"}))}function pt(t){S=It(t),j()}function Se(t,e){if(!C().some(i=>i.id===t))return;const a=W(),n=a.find(i=>i.productId===t);n?n.quantity=It(e):a.push({productId:t,quantity:It(e)}),v(f.cart,a),G();const s=document.querySelector("#cart-button");s?.classList.remove("is-updated"),s?.offsetWidth,s?.classList.add("is-updated")}function Qe(t,e){const a=W(),n=a.find(s=>s.productId===t);n&&(n.quantity=It(e),v(f.cart,a),G())}function va(t){v(f.cart,W().filter(e=>e.productId!==t)),G()}function G(){const t=document.querySelector("#request-summary"),e=document.querySelector("#cart-count"),a=document.querySelector('#request-form button[type="submit"]'),n=W(),s=V();if(e&&(e.textContent=String(n.length)),a&&(a.disabled=n.length===0),!t)return;if(!n.length){t.innerHTML=`
    ...
    `;return}let i=0;const r=n.map(u=>{const o=C().find(d=>d.id===u.productId);if(!o)return"";const l=vt(o,u.quantity,s),g=l*u.quantity;return i+=g,`
        <article class="cart-item">
          ...
          <label class="cart-item__quantity">
            ...
            <div class="cart-item__quantity-control">
              ...
              <input class="input" type="number" min="1" max="${Mt}" value="${u.quantity}" data-cart-quantity="${c(o.id)}" />
  ...
  `}function ya(t){const e=Z().find(i=>i.id===t);if(!e)return;const a=new Set(C().map(i=>i.id)),n=e.items.filter(i=>a.has(i.productId)).map(i=>({productId:i.productId,quantity:It(i.quantity)}));if(!n.length)return;const s=W().filter(i=>!n.some(r=>r.productId===i.productId));v(f.cart,[...s,...n]),G(),window.location.hash="request",window.setTimeout(()=>document.querySelector("#request")?.scrollIntoView({behavior:"smooth",block:"start"}),80)}function J(){const t=document.querySelector("#account-button"),e=V();if(!t)return;t.textContent=e?e.name.split(" ")[0]:"Кабінет",t.classList.toggle("is-signed-in",!!e);const a=document.querySelector("#request-account-hint");a&&(a.textContent=e?e.name:"Гість");const n=document.querySelector("#request-form");if(n&&e){const s=(i,r)=>{const u=n.elements.namedItem(i);u instanceof HTMLInputElement&&!u.value&&(u.value=r)};s("name",e.name),s("phone",e.phone),s("company",e.company)}G()}function $a(){const t=V();if(t){const e=Z().filter(g=>g.accountId===t.id).slice().reverse(),a=e.filter(g=>g.status!=="Закрита").length,n=e.reduce((g,d)=>g+d.total,0),s=t.name.split(/\s+/).filter(Boolean).slice(0,2).map(g=>g[0]).join("").toLocaleUpperCase("uk-UA"),i=$t(),r=vt(i,S,t),u=C().flatMap(g=>{const d=ot(g,t);return d===null?[]:[{product:g,price:d}]}),o=u.length,l=o>0;return`
  ...
  `}function B(){const t=document.querySelector("#account-page-content");t&&(t.innerHTML=$a())}function wa(t){return`
  ...
  `}function Sa(){const t=V(),e=document.querySelector("#profile-dialog"),a=document.querySelector("#profile-dialog-content");!t||!e||!a||(a.innerHTML=wa(t),typeof e.showModal=="function"?e.showModal():e.setAttribute("open",""),a.querySelector('input[name="name"]')?.focus())}async function _a(t){t.classList.add("was-validated");const e=t.querySelector("[data-profile-status]");if(!t.reportValidity()){e&&(e.className="form-status is-error",e.textContent="Перевірте ім’я, телефон і новий пароль.");return}const a=V();if(!a)return;const n=new FormData(t),s=Dt(String(n.get("phone")??"")),i=K();if(i.some(o=>o.id!==a.id&&ht(o.phone)===ht(s))){e&&(e.className="form-status is-error",e.textContent="Акаунт із таким номером уже існує.");return}const r=String(n.get("password")??"");if(L){try{const o=await k.updateMe({name:String(n.get("name")??"").trim(),phone:s,company:String(n.get("company")??"").trim(),...r?{password:r}:{}});Nt(o),document.querySelector("#profile-dialog")?.close(),J(),B(),j(),N(!1)}catch(o){e&&(e.className="form-status is-error",e.textContent=H(o,"Не вдалося оновити профіль."))}return}const u=i.map(o=>o.id===a.id?{...o,name:String(n.get("name")??"").trim(),phone:s,company:String(n.get("company")??"").trim(),password:r||o.password}:o);v(f.accounts,u),document.querySelector("#profile-dialog")?.close(),J(),B(),j(),N(!1)}function Zt(t,e,a){const n=t.querySelector("[data-auth-status]");n&&(n.textContent=e,n.className=`form-status is-${a}`)}function H(t,e){return t instanceof Tt?t.message:e}function qa(t,e){const a=ht(t),n=K().find(s=>ht(s.phone)===a&&s.password===e);return n?(localStorage.setItem(f.session,n.id),n):null}async function _e(t,e=!1){if(t.classList.add("was-validated"),!t.reportValidity())return;const a=new FormData(t);let n=null;if(L)try{const s=await k.login(String(a.get("phone")??""),String(a.get("password")??""));e&&s.role!=="admin"?rt():(n=Nt(s),await Qt())}catch(s){Zt(t,H(s,"Сервер авторизації недоступний."),"error");return}else n=qa(String(a.get("phone")??""),String(a.get("password")??""));if(!n||e&&n.role!=="admin"){Zt(t,e?"Потрібен акаунт менеджера.":"Невірний телефон або пароль.","error");return}J(),j(),N(!1),e?w():(B(),window.location.hash="account")}async function ka(t){if(t.classList.add("was-validated"),!t.reportValidity())return;const e=new FormData(t),a=Dt(String(e.get("phone")??""));if(L){try{const i=await k.register({name:String(e.get("name")??"").trim(),phone:a,company:String(e.get("company")??"").trim(),password:String(e.get("password")??"")});Nt(i),v(f.orders,[]),J(),j(),N(!1),B(),window.location.hash="account"}catch(i){Zt(t,H(i,"Не вдалося створити акаунт."),"error")}return}const n=K();if(n.some(i=>ht(i.phone)===ht(a))){Zt(t,"Акаунт із таким номером уже існує.","error");return}const s={id:`account-${Date.now().toString(36)}`,name:String(e.get("name")??"").trim(),phone:a,company:String(e.get("company")??"").trim(),password:String(e.get("password")??""),role:"client",partner:!1,fixedMarkup:Ct,productPrices:{},createdAt:new Date().toISOString()};n.push(s),v(f.accounts,n),localStorage.setItem(f.session,s.id),J(),j(),N(!1),B(),window.location.hash="account"}async function xa(t){const e=document.querySelector("#request-status"),a=W();if(!a.length){e&&(e.className="form-status is-error",e.textContent="Додайте хоча б одну коробку до кошика.");return}if(t.classList.add("was-validated"),!t.reportValidity()){e&&(e.className="form-status is-error",e.textContent="Перевірте обов’язкові поля та згоду.");return}const n=new FormData(t),s=V(),i=Dt(String(n.get("phone")??"")),r=s??K().find(m=>Dt(m.phone)===i),u=a.flatMap(m=>{const h=C().find(T=>T.id===m.productId);if(!h)return[];const $=vt(h,m.quantity,s);return[{productId:h.id,productNumber:h.number,dimensions:h.dimensions,quantity:m.quantity,unitPrice:$,total:$*m.quantity,priceType:Yt(m.quantity,s,h)}]}),o=u.reduce((m,h)=>m+h.total,0);if(L){const m=t.querySelector('button[type="submit"]');m&&(m.disabled=!0,m.dataset.originalText=m.textContent??"",m.textContent="Зберігаємо заявку…");try{const h=await k.createOrder({customerName:String(n.get("name")??"").trim(),phone:i,company:String(n.get("company")??"").trim(),comment:String(n.get("comment")??"").trim(),items:a.map($=>({productId:$.productId,quantity:$.quantity}))});v(f.orders,[...Z().filter($=>$.id!==h.id),h]),v(f.cart,[]),G(),B(),e&&(e.className="form-status is-success",e.innerHTML=`<strong>Заявку ${c(h.id)} створено.</strong><span>${zt(h.items.length)} на суму ${y(h.total)}. Менеджер побачить її в адмінці.</span>`)}catch(h){e&&(e.className="form-status is-error",e.textContent=H(h,"Не вдалося передати заявку на сервер."))}finally{m&&(m.disabled=!1,m.textContent=m.dataset.originalText||"Надіслати заявку",m.focus())}return}const l=new Date().toISOString(),g={id:`TP-${Date.now().toString(36).toUpperCase()}`,createdAt:l,customerName:String(n.get("name")??"").trim(),phone:i,company:String(n.get("company")??"").trim(),comment:String(n.get("comment")??"").trim(),items:u,total:o,accountId:r?.id,status:"Нова",statusHistory:[{status:"Нова",at:l}]},d=Z();d.push(g),v(f.orders,d),v(f.cart,[]),G(),B(),e&&(e.className="form-status is-success",e.innerHTML=`<strong>Заявку ${c(g.id)} створено.</strong><span>${zt(g.items.length)} на суму ${y(g.total)}. Номер можна повідомити менеджеру.</span>`),t.querySelector('button[type="submit"]')?.focus()}const Aa=["Нова","У роботі","Уточнення","Підтверджена","Закрита"];function qe(t){return t==="Нова"?"is-new":t==="У роботі"?"is-progress":t==="Уточнення"?"is-clarifying":t==="Підтверджена"?"is-confirmed":"is-closed"}function La(t){return`
  ...
  `}function At(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),n=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${n}`}function Lt(t){const[e,a,n]=t.split("-").map(Number);return new Date(e,Math.max(0,(a||1)-1),n||1,12)}function dt(t){return Lt(t).toLocaleDateString("uk-UA",{day:"2-digit",month:"2-digit",year:"numeric"})}function ze(t=!1){const a=At(new Date),s=Lt(kt||A||a),i=new Date(s.getFullYear(),s.getMonth(),1,12);kt=At(i);const r=(i.getDay()+6)%7,u=new Date(i);u.setDate(i.getDate()-r);const o=Array.from({length:42},($,T)=>{const R=new Date(u);R.setDate(u.getDate()+T);const U=At(R),me=R.getMonth()!==i.getMonth(),st=U===A,_t=U===P,at=st||_t,Ht=!!(A&&P&&U>A&&U<P);return`<button class="${[me?"is-outside":"",Ht?"is-in-range":"",st?"is-range-start":"",_t?"is-range-end":"",at?"is-selected":"",U===a?"is-today":""].filter(Boolean).join(" ")}" type="button" data-calendar-date="${U}" aria-label="${R.toLocaleDateString("uk-UA",{day:"numeric",month:"long",year:"numeric"})}" aria-pressed="${at}">${R.getDate()}</button>`}).join(""),l=A?P&&P!==A?`${dt(A)} — ${dt(P)}`:dt(A):"Усі дати",g=A&&P?Math.round((Lt(P).getTime()-Lt(A).getTime())/864e5)+1:0,d=A?P?g===1?"Обрано один день":`Обрано ${g} дн.`:"Тепер оберіть кінець":"Оберіть початок",m=A?P?`${dt(A)} — ${dt(P)}`:`Початок: ${dt(A)}`:"Перший клік — початкова дата",h=i.toLocaleDateString("uk-UA",{month:"long",year:"numeric"});return`
    <div class="admin-calendar${t?" is-open":""}" data-admin-calendar>
      ...
      <div class="admin-calendar__popover" role="dialog" aria-label="Оберіть період заявок"${t?"":" hidden"}>
        ...
        <div class="admin-calendar__range-state${A&&!P?" is-pending":""}" aria-live="polite">
          <span aria-hidden="true">${A&&P?"✓":A?"2":"1"}</span>
  ...
  `}function Pa(){return window.location.hash==="#admin-orders"?"orders":window.location.hash==="#admin-clients"?"clients":window.location.hash==="#admin-products"?"products":"overview"}function Ta(t,e,a,n){return[{view:"overview",href:"#admin",label:"Огляд"},{view:"orders",href:"#admin-orders",label:"Замовлення",count:e},{view:"clients",href:"#admin-clients",label:"Клієнти",count:a},{view:"products",href:"#admin-products",label:"Товари",count:n}].map((i,r)=>`
      ...
      `).join("")}function Ma(t,e,a){const n=Z(),s=K().filter(u=>u.role==="client"),i=O().length,r=q?`<div class="admin-notice" role="status"><span>Готово</span><p>${c(q)}</p></div>`:"";return q="",`
  ...
  `}function Ca(t,e){const a=t.filter(r=>r.status!=="Закрита").length,n=t.reduce((r,u)=>r+u.total,0),s=C().length,i=t.slice(0,3);return`
  ...
  `}function Ea(t){const e=["Усі","Нова","У роботі","Уточнення","Підтверджена","Закрита"];return`
    ...
    <div class="admin-toolbar">
      <label class="admin-search"><span class="sr-only">Пошук заявок</span><input id="admin-order-search" type="search" value="${c(ue)}" placeholder="Номер, ім’я або телефон" /></label>
      ${ze()}
  ...
  `}function Da(t){if(!it.size){const e=t.find(a=>a.partner)??t[0];e&&it.add(e.id)}return`
    <div class="admin-page-heading">
  ...
  `}function pe(){const t=le.trim().toLocaleLowerCase("uk-UA");return O().filter(e=>{const a=!t||`${e.number} ${e.name} ${E(e.dimensions)}`.toLocaleLowerCase("uk-UA").includes(t),n=lt==="all"||(lt==="active"?e.active:!e.active);return a&&n})}function Ke(){const t=pe();return t.length?t.map(e=>`
      ...
      `).join(""):'<div class="admin-empty"><h3>Нічого не знайдено.</h3><p>Змініть пошук або фільтр видимості.</p></div>'}function Oa(){return`
    ...
    <div class="admin-toolbar admin-toolbar--products">
      <label class="admin-search"><span class="sr-only">Пошук товарів</span><input id="admin-product-search" type="search" value="${c(le)}" placeholder="Номер або розмір" /></label>
    ...
    <div class="admin-results-meta"><strong id="admin-product-count">${pe().length}</strong><span>товарів показано</span></div>
    <div class="admin-products-grid" id="admin-product-list">${Ke()}</div>
  `}function w(){const t=document.querySelector("#admin-content");if(!t)return;const e=V();if(!e||e.role!=="admin"){t.innerHTML=`
    ...
    `;return}const a=Z().slice().reverse(),n=K().filter(r=>r.role==="client"),s=Pa();let i=Ca(a,n);s==="orders"&&(i=Ea(a)),s==="clients"&&(i=Da(n)),s==="products"&&(i=Oa()),t.innerHTML=Ma(e,s,i),s==="orders"&&Pt()}function Pt(){const t=ue.trim().toLocaleLowerCase("uk-UA");let e=0;document.querySelectorAll("[data-admin-order]").forEach(n=>{const s=!t||(n.dataset.search??"").includes(t),i=Rt==="Усі"||n.dataset.status===Rt,r=n.dataset.date??"",u=!A||!P&&r===A||!!(P&&r>=A&&r<=P);n.hidden=!(s&&i&&u),n.hidden||(e+=1)});const a=document.querySelector("#admin-order-count");a&&(a.textContent=String(e))}function Bt(t){document.querySelectorAll("[data-order-status-control]").forEach(e=>{e!==t&&(e.classList.remove("is-open"),e.querySelector(".order-status-control__menu")?.setAttribute("hidden",""),e.querySelector("[data-order-status-trigger]")?.setAttribute("aria-expanded","false"))})}function Je(){const t=document.querySelector("[data-admin-calendar]");t&&(t.classList.remove("is-open"),t.querySelector(".admin-calendar__popover")?.setAttribute("hidden",""),t.querySelector("[data-calendar-trigger]")?.setAttribute("aria-expanded","false"))}function jt(t,e){const a=document.querySelector("[data-admin-calendar]");a&&(a.outerHTML=ze(t),e&&window.requestAnimationFrame(()=>document.querySelector(`[data-admin-calendar] ${e}`)?.focus()))}async function Na(t,e){const a=Z(),n=a.find(i=>i.id===t);if(!n||n.status===e)return;if(L){try{const i=await k.updateOrder(t,{status:e});v(f.orders,a.map(r=>r.id===t?i:r))}catch(i){q=H(i,"Не вдалося змінити статус заявки.")}w();return}const s=n.status;n.status=e,n.statusHistory=[...n.statusHistory??[{status:s,at:n.createdAt}],{status:e,at:new Date().toISOString()}],v(f.orders,a),w()}function Ua(t){const e=t.trim().toLocaleLowerCase("uk-UA");document.querySelectorAll("[data-admin-client]").forEach(a=>{a.hidden=!!e&&!(a.dataset.search??"").includes(e)})}function Ha(){const t=document.querySelector("#admin-product-list");t&&(t.innerHTML=Ke());const e=document.querySelector("#admin-product-count");e&&(e.textContent=String(pe().length))}function Q(){const t=C();if(!t.length)return;t.some(n=>n.id===tt)||(tt=t[0].id),je(!0);const e=document.querySelector("#hero-product-count");e&&(e.textContent=String(t.length));const a=document.querySelector("#catalog-ready-label");a&&(a.innerHTML=`<span></span> ${t.length} готових розмірів`),N(!1),j(),G()}function Fa(t){const e=!!t,a=t??{id:"",number:"",name:"",dimensions:{length:180,width:120,height:50},basePrice:5,active:!0};return`
  ...
  `}function ke(t){const e=document.querySelector("#admin-product-dialog"),a=document.querySelector("#admin-product-editor");if(!e||!a)return;const n=t?O().find(s=>s.id===t):void 0;a.innerHTML=Fa(n),typeof e.showModal=="function"?e.showModal():e.setAttribute("open",""),a.querySelector('input[name="number"]')?.focus()}async function ja(t){t.classList.add("was-validated");const e=t.querySelector("[data-product-form-status]");if(!t.reportValidity()){e&&(e.className="form-status is-error",e.textContent="Перевірте обов’язкові поля.");return}const a=new FormData(t),n=String(a.get("productId")??""),s=String(a.get("number")??"").trim(),i=O(),r=i.find(d=>d.id===n);if(!Pe.test(s)){e&&(e.className="form-status is-error",e.textContent="У номері можна використовувати літери, цифри, крапку, дефіс і підкреслення.");return}if(i.some(d=>d.number.toLocaleLowerCase("uk-UA")===s.toLocaleLowerCase("uk-UA")&&d.id!==n)){e&&(e.className="form-status is-error",e.textContent="Товар із таким номером уже існує.");return}const u=a.get("active")==="on";if(r?.active&&!u&&C().length<=1){e&&(e.className="form-status is-error",e.textContent="У каталозі має залишитися хоча б один активний товар.");return}const o=r?.id??`box-${s.toLocaleLowerCase("uk-UA").replace(/[^a-zа-яіїєґ0-9]+/giu,"-")}-${Date.now().toString(36)}`,l={...r,id:o,number:s,name:String(a.get("name")??"").trim()||`Самозбірна коробка №${s}`,dimensions:{length:Number(a.get("length")),width:Number(a.get("width")),height:Number(a.get("height"))},basePrice:Number(a.get("basePrice")),active:u,updatedAt:new Date().toISOString()};if(L){try{const d=r?await k.updateProduct(r.id,l):await k.createProduct({number:l.number,name:l.name,dimensions:l.dimensions,basePrice:l.basePrice,sourceQuantity:l.sourceQuantity,active:l.active}),m=r?i.map(h=>h.id===r.id?d:h):[...i,d];F(m),Q(),document.querySelector("#admin-product-dialog")?.close(),q=r?`Товар №${s} оновлено.`:`Товар №${s} додано до каталогу.`,w()}catch(d){e&&(e.className="form-status is-error",e.textContent=H(d,"Не вдалося зберегти товар на сервері."))}return}const g=r?i.map(d=>d.id===r.id?l:d):[...i,l];F(g),Q(),document.querySelector("#admin-product-dialog")?.close(),q=r?`Товар №${s} оновлено.`:`Товар №${s} додано до каталогу.`,w()}function xe(t,e){const a=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(a),s=document.createElement("a");s.href=n,s.download=t,s.click(),window.setTimeout(()=>URL.revokeObjectURL(n),0)}function Ba(t,e,a){const n=new Blob([e],{type:a}),s=URL.createObjectURL(n),i=document.createElement("a");i.href=s,i.download=t,i.click(),window.setTimeout(()=>URL.revokeObjectURL(s),0)}function Va(t){const e=String(t);return/[;"\n\r]/.test(e)?`"${e.replaceAll('"','""')}"`:e}function Ra(){const t=["number","name","length","width","height","basePrice","active"],e=O().map(a=>[a.number,a.name,a.dimensions.length,a.dimensions.width,a.dimensions.height,a.basePrice,a.active].map(Va).join(";"));return`\uFEFF${[t.join(";"),...e].join(`\r
`)}`}function Qa(){return{version:1,createdAt:new Date().toISOString(),accounts:K(),orders:Z(),products:O(),cart:W(),measurements:nt(),fit:x?{dimensions:x,margin:M}:null}}function za(t){if(!t||typeof t!="object")return!1;const e=t;if(e.version!==1||!Array.isArray(e.accounts)||!Array.isArray(e.orders)||!Array.isArray(e.products))return!1;const a=e.accounts.every(i=>i&&typeof i.id=="string"&&typeof i.phone=="string"&&(i.role==="admin"||i.role==="client")),n=e.products.every(i=>i&&typeof i.id=="string"&&typeof i.number=="string"&&Number.isFinite(i.basePrice)&&[i.dimensions?.length,i.dimensions?.width,i.dimensions?.height].every(r=>Number.isFinite(r)&&Number(r)>0)),s=e.orders.every(i=>i&&typeof i.id=="string"&&typeof i.phone=="string"&&Array.isArray(i.items)&&Number.isFinite(i.total));return a&&n&&s&&e.accounts.some(i=>i.role==="admin")}async function Za(t){const e=t.files?.[0];if(e){if(L){q="Серверну копію можна завантажити, а відновлення виконується тільки на сервері адміністратором інфраструктури.",t.value="",w();return}try{const a=JSON.parse(await e.text());if(!za(a))throw new Error("Файл не є коректною резервною копією ToffiPacks.");if(!window.confirm("Відновити локальні дані з цієї копії? Поточні заявки, клієнти й товари буде замінено."))return;v(f.accounts,a.accounts),v(f.orders,a.orders),v(f.products,a.products),v(f.cart,Array.isArray(a.cart)?a.cart:[]),v(f.measurements,Array.isArray(a.measurements)?a.measurements:[]),a.fit?v(f.fit,a.fit):localStorage.removeItem(f.fit),x=a.fit?.dimensions??null,M=a.fit?.margin===5||a.fit?.margin===10?a.fit.margin:0,K().some(n=>n.id===localStorage.getItem(f.session))||localStorage.removeItem(f.session),Q(),J(),B(),q=`Резервну копію від ${new Date(a.createdAt).toLocaleString("uk-UA")} відновлено.`,w()}catch(a){q=a instanceof Error?a.message:"Не вдалося відновити резервну копію.",w()}finally{t.value=""}}}function Ka(t){const e=[];let a=[],n="",s=!1;for(let i=0;i<t.length;i+=1){const r=t[i];r==='"'?s&&t[i+1]==='"'?(n+='"',i+=1):s=!s:r===";"&&!s?(a.push(n.trim()),n=""):(r===`
`||r==="\r")&&!s?(r==="\r"&&t[i+1]===`
`&&(i+=1),a.push(n.trim()),a.some(Boolean)&&e.push(a),a=[],n=""):n+=r}return a.push(n.trim()),a.some(Boolean)&&e.push(a),e}function Ja(t){const e=Ka(t.replace(/^\uFEFF/,"")),a=e.shift()?.map(l=>l.trim())??[],n=["number","name","length","width","height","basePrice","active"];if(!n.every(l=>a.includes(l)))throw new Error(`Потрібні колонки: ${n.join(", ")}`);const s=Object.fromEntries(a.map((l,g)=>[l,g])),i=O(),r=new Map(i.map(l=>[l.number.toLocaleLowerCase("uk-UA"),l])),u=e.map(l=>{const g=U=>l[s[U]]?.trim()??"",d=g("number"),m=U=>Number(g(U).replace(",",".")),h={length:m("length"),width:m("width"),height:m("height")},$=m("basePrice");if(!Pe.test(d)||!Object.values(h).every(U=>Number.isFinite(U)&&U>0)||!Number.isFinite($)||$<=0)throw new Error(`Некоректні дані для коробки ${d||"без номера"}.`);const T=r.get(d.toLocaleLowerCase("uk-UA")),R=g("active").toLocaleLowerCase("uk-UA");return{...T,id:T?.id??`box-${d.toLocaleLowerCase("uk-UA").replace(/[^a-zа-яіїєґ0-9]+/giu,"-")}-${Date.now().toString(36)}`,number:d,name:g("name")||T?.name||`Самозбірна коробка №${d}`,dimensions:h,basePrice:$,active:!["false","0","ні","no"].includes(R),updatedAt:new Date().toISOString()}}),o=new Set(u.map(l=>l.number.toLocaleLowerCase("uk-UA")));return[...i.filter(l=>!o.has(l.number.toLocaleLowerCase("uk-UA"))),...u]}async function Wa(t){const e=t.files?.[0];if(e)try{const a=Ja(await e.text());if(!window.confirm(`Імпортувати ${a.length} товарів? Позиції з однаковими номерами буде оновлено.`))return;if(L){const n=await k.adminProducts();for(const s of a){const i=n.find(r=>r.id===s.id||r.number.toLocaleLowerCase("uk-UA")===s.number.toLocaleLowerCase("uk-UA"));i?await k.updateProduct(i.id,s):await k.createProduct({number:s.number,name:s.name,dimensions:s.dimensions,basePrice:s.basePrice,sourceQuantity:s.sourceQuantity,active:s.active})}F(await k.adminProducts()),Q(),q="CSV імпортовано на сервер. Каталог оновлено.",w();return}F(a),Q(),q="CSV імпортовано. Каталог оновлено.",w()}catch(a){q=a instanceof Error?a.message:"Не вдалося прочитати CSV.",w()}finally{t.value=""}}function Xt(){const t=document.querySelector("#admin-page"),e=document.querySelector("#account-page"),a=document.querySelector("#main"),n=document.querySelector(".site-header"),s=document.querySelector(".site-footer"),i=document.querySelector("#support-widget"),r=document.querySelector(".demo-strip"),u=["#admin","#admin-orders","#admin-clients","#admin-products"].includes(window.location.hash),o=window.location.hash==="#account";t&&(t.hidden=!u),e&&(e.hidden=!o),a&&(a.hidden=u||o),n&&(n.hidden=u||o),s&&(s.hidden=u||o),i&&(i.hidden=u),r&&(r.hidden=u||o),document.body.classList.toggle("is-admin",u),document.body.classList.toggle("is-account",o),u?(Ut(!1),w(),L&&ft()&&Qt().then(()=>w()).catch(l=>{q=H(l,"Не вдалося оновити дані адмінки."),w()}),window.scrollTo({top:0})):o&&(B(),L&&ft()&&Qt().then(()=>{J(),B()}).catch(()=>{}),window.scrollTo({top:0}))}function Ya(){const t=document.querySelectorAll(".reveal");if(!("IntersectionObserver"in window)){t.forEach(a=>a.classList.add("is-visible"));return}const e=new IntersectionObserver(a=>{a.forEach(n=>{n.isIntersecting&&(n.target.classList.add("is-visible"),e.unobserve(n.target))})},{threshold:.12});t.forEach(a=>e.observe(a))}document.querySelector("#menu-button")?.addEventListener("click",t=>{const e=t.currentTarget,a=document.querySelector("#site-nav"),n=e.getAttribute("aria-expanded")!=="true";e.setAttribute("aria-expanded",String(n)),a?.classList.toggle("is-open",n)});document.querySelector("#support-trigger")?.addEventListener("click",()=>{document.querySelector("#support-panel")?.hidden?da():Ut()});document.querySelector("[data-support-close]")?.addEventListener("click",()=>{Ut()});document.querySelectorAll(".site-nav a").forEach(t=>{t.addEventListener("click",()=>{document.querySelector("#site-nav")?.classList.remove("is-open"),document.querySelector("#menu-button")?.setAttribute("aria-expanded","false")})});document.querySelector('.site-header .brand[href="#top"]')?.addEventListener("click",t=>{t.preventDefault(),window.location.hash!=="#top"&&(window.history.pushState(null,"","#top"),Xt()),window.scrollTo({top:0,behavior:window.matchMedia("(prefers-reduced-motion: reduce)").matches?"auto":"smooth"})});document.querySelector("#fit-form")?.addEventListener("submit",t=>{t.preventDefault();const e=t.currentTarget;e.classList.add("was-validated");const a=document.querySelector("#fit-message");if(!e.reportValidity()){a&&(a.textContent="Вкажіть три додатні розміри.",a.className="form-message is-error");return}const n=new FormData(e);x={length:Number(n.get("length")),width:Number(n.get("width")),height:Number(n.get("height"))};const s=Number(n.get("fitMargin"));M=s===5||s===10?s:0,Ne(x,M),X=!1,a&&(a.textContent=`Розміри застосовано · ${ct(M)}.`,a.className="form-message is-success"),St(),window.setTimeout(()=>document.querySelector("#catalog")?.scrollIntoView({behavior:"smooth"}),180)});document.querySelector("#catalog-search")?.addEventListener("input",t=>{Ot=t.currentTarget.value,X=!1,St()});const et=document.querySelector("#catalog-sort"),mt=et?.querySelector(".catalog-sort__trigger"),bt=et?.querySelector(".catalog-sort__menu"),Y=Array.from(et?.querySelectorAll("[data-sort-value]")??[]);function Gt(t=!1){!mt||!bt||(mt.setAttribute("aria-expanded","false"),bt.hidden=!0,et?.classList.remove("is-open"),t&&mt.focus())}function We(){!mt||!bt||(mt.setAttribute("aria-expanded","true"),bt.hidden=!1,et?.classList.add("is-open"))}function Xa(t){const e=Y.find(n=>n.dataset.sortValue===t),a=document.querySelector("#catalog-sort-value");!e||!et||!a||(ie=t,et.dataset.value=t,a.textContent=e.querySelector("span")?.textContent??e.textContent,Y.forEach(n=>{n.setAttribute("aria-selected",String(n===e))}),Gt(!0),St())}mt?.addEventListener("click",()=>{bt?.hidden?We():Gt()});Y.forEach(t=>{t.addEventListener("click",()=>{Xa(t.dataset.sortValue)})});et?.addEventListener("keydown",t=>{const e=Y.indexOf(document.activeElement),a=Y.findIndex(s=>s.getAttribute("aria-selected")==="true");if(t.key==="Escape"){t.preventDefault(),Gt(!0);return}if(t.key!=="ArrowDown"&&t.key!=="ArrowUp"&&t.key!=="Home"&&t.key!=="End")return;t.preventDefault(),bt?.hidden&&We();let n=e>=0?e:a;t.key==="Home"&&(n=0),t.key==="End"&&(n=Y.length-1),t.key==="ArrowDown"&&(n=(n+1)%Y.length),t.key==="ArrowUp"&&(n=(n-1+Y.length)%Y.length),Y[n]?.focus()});document.addEventListener("click",t=>{et?.contains(t.target)||Gt()});document.querySelector("#reset-catalog")?.addEventListener("click",()=>{x=null,M=0,Ot="",X=!1;const t=document.querySelector("#catalog-search");t&&(t.value="");const e=document.querySelector("#fit-message");e&&(e.textContent=""),localStorage.removeItem(f.fit),St()});document.querySelector("#catalog-more-button")?.addEventListener("click",()=>{X=!X,N(!1),X||document.querySelector("#catalog")?.scrollIntoView({behavior:"smooth",block:"start"})});window.addEventListener("resize",()=>N(!1));document.querySelector("#quantity-input")?.addEventListener("input",t=>{pt(Number(t.currentTarget.value))});document.querySelector("#hero-quantity-input")?.addEventListener("input",t=>{pt(Number(t.currentTarget.value))});document.querySelector("#request-form")?.addEventListener("submit",t=>{t.preventDefault(),xa(t.currentTarget)});document.addEventListener("click",t=>{const e=t.target,a=e.closest("[data-support-topic]");if(a?.dataset.supportTopic){la(a.dataset.supportTopic);return}if(e.closest("[data-support-back]")){ua();return}if(e.closest("[data-support-action]")){Ut(!1);return}const n=e.closest("[data-product-picker-value]");if(n?.dataset.productPickerValue){const p=n.closest("[data-product-picker]");p&&ut(p,!0),Re(n.dataset.productPickerValue);return}const s=e.closest("[data-product-picker-trigger]");if(s){const p=s.closest("[data-product-picker]");p&&ba(p);return}e.closest("[data-product-picker]")||Be(),e.closest("[data-order-status-control]")||Bt(),e.closest("[data-admin-calendar]")||Je();const i=e.closest("[data-order-status-trigger]");if(i){const p=i.closest("[data-order-status-control]"),b=p?.querySelector(".order-status-control__menu");if(!p||!b)return;const _=b.hidden;Bt(p),b.hidden=!_,p.classList.toggle("is-open",_),i.setAttribute("aria-expanded",String(_));return}const r=e.closest("[data-order-status-option]");if(r?.dataset.orderId&&r.dataset.orderStatusOption){Na(r.dataset.orderId,r.dataset.orderStatusOption);return}const u=e.closest("[data-calendar-trigger]");if(u){const p=u.closest("[data-admin-calendar]"),b=p?.querySelector(".admin-calendar__popover");if(!p||!b)return;const _=b.hidden;Bt(),b.hidden=!_,p.classList.toggle("is-open",_),u.setAttribute("aria-expanded",String(_));return}const o=e.closest("[data-calendar-month]");if(o?.dataset.calendarMonth){const p=Lt(kt||At(new Date));p.setMonth(p.getMonth()+Number(o.dataset.calendarMonth),1),kt=At(p),jt(!0,`[data-calendar-month="${o.dataset.calendarMonth}"]`);return}const l=e.closest("[data-calendar-date]");if(l?.dataset.calendarDate){const p=l.dataset.calendarDate;kt=p,!A||P?(A=p,P="",jt(!0,`[data-calendar-date="${p}"]`)):(P=p,P<A&&([A,P]=[P,A]),jt(!1)),Pt();return}if(e.closest("[data-calendar-clear]")){A="",P="",jt(!1),Pt();return}const g=e.closest("[data-saved-measurement]");if(g?.dataset.savedMeasurement){const p=nt().find(b=>b.id===g.dataset.savedMeasurement);p&&ra(p);return}if(e.closest("[data-clear-measurements]")){localStorage.removeItem(f.measurements),Oe(),B();return}if(e.closest("[data-use-tight-fit]")&&x){M=0,Ne(x,M);const p=document.querySelector('#fit-form input[name="fitMargin"][value="0"]');p&&(p.checked=!0),St();return}const d=e.closest("[data-open-product]");if(d?.dataset.openProduct){we(d.dataset.openProduct);return}const m=e.closest("[data-quantity]");if(m?.dataset.quantity){pt(Number(m.dataset.quantity));return}const h=e.closest("[data-quantity-step]");if(h?.dataset.quantityStep){pt(S+Number(h.dataset.quantityStep));return}if(e.closest("[data-product-to-cart]")){Se(gt??tt,S),xt();return}if(e.closest("[data-add-selected-to-cart]")){Se(tt,S);return}const $=e.closest("[data-cart-step]");if($?.dataset.cartProduct&&$.dataset.cartStep){const p=W().find(b=>b.productId===$.dataset.cartProduct);p&&Qe(p.productId,p.quantity+Number($.dataset.cartStep));return}const T=e.closest("[data-edit-cart]");if(T?.dataset.editCart){const p=W().find(b=>b.productId===T.dataset.editCart);p&&(pt(p.quantity),we(p.productId));return}if(e.closest("[data-clear-cart]")){window.confirm("Очистити всі позиції кошика?")&&(v(f.cart,[]),G());return}const R=e.closest("[data-repeat-order]");if(R?.dataset.repeatOrder){ya(R.dataset.repeatOrder);return}const U=e.closest("[data-remove-cart]");if(U?.dataset.removeCart){va(U.dataset.removeCart);return}if(e.closest("[data-product-to-calculator]")){xt(()=>{window.location.hash="calculator",document.querySelector("#calculator")?.scrollIntoView({behavior:"smooth",block:"start"})});return}if(e.closest("[data-close-dialog]")){xt();return}if(e.closest("[data-edit-profile]")){Sa();return}if(e.closest("[data-close-profile]")){document.querySelector("#profile-dialog")?.close();return}const st=e.closest("[data-auth-tab]");if(st?.dataset.authTab){const p=st.closest(".auth-forms");p?.querySelectorAll("[data-auth-tab]").forEach(b=>{const _=b.dataset.authTab===st.dataset.authTab;b.classList.toggle("is-active",_),b.setAttribute("aria-selected",String(_))}),p?.querySelectorAll("[data-auth-panel]").forEach(b=>{b.hidden=b.dataset.authPanel!==st.dataset.authTab});return}if(e.closest("#logout-button")){L&&k.logout().catch(()=>rt()),localStorage.removeItem(f.session),J(),j(),N(!1),B();return}const _t=e.closest("[data-account-price-product]");if(_t?.dataset.accountPriceProduct){const p=C().find(b=>b.id===_t.dataset.accountPriceProduct);p&&(tt=p.id,j(),N(!1),window.location.hash="calculator");return}const at=e.closest("[data-client-prices-toggle]");if(at?.dataset.clientPricesToggle){const p=at.dataset.clientPricesToggle,b=document.getElementById(`client-prices-${p}`),_=!at.classList.contains("is-open");at.classList.toggle("is-open",_),at.setAttribute("aria-expanded",String(_)),_?(it.add(p),b&&(b.hidden=!1,window.requestAnimationFrame(()=>b.classList.add("is-open")))):(it.delete(p),b?.classList.remove("is-open"),window.setTimeout(()=>{b&&!b.classList.contains("is-open")&&(b.hidden=!0)},220));return}if(e.closest("[data-create-product]")){ke();return}const Ht=e.closest("[data-edit-product]");if(Ht?.dataset.editProduct){ke(Ht.dataset.editProduct);return}if(e.closest("[data-close-admin-product]")){document.querySelector("#admin-product-dialog")?.close();return}const te=e.closest("[data-toggle-product]");if(te?.dataset.toggleProduct){const p=O(),b=p.find(_=>_.id===te.dataset.toggleProduct);if(b){if(L){k.updateProduct(b.id,{active:!b.active}).then(_=>{F(p.map(he=>he.id===b.id?_:he)),Q(),q=_.active?`Товар №${_.number} повернуто на сайт.`:`Товар №${_.number} приховано.`,w()}).catch(_=>{q=H(_,"Не вдалося змінити видимість товару."),w()});return}b.active&&C().length<=1?q="У каталозі має залишитися хоча б один активний товар.":(b.active=!b.active,b.updatedAt=new Date().toISOString(),F(p),Q(),q=b.active?`Товар №${b.number} повернуто на сайт.`:`Товар №${b.number} приховано.`),w()}return}const ee=e.closest("[data-delete-product]");if(ee?.dataset.deleteProduct){const p=O(),b=p.find(_=>_.id===ee.dataset.deleteProduct);if(!b)return;if(b.active&&C().length<=1){q="Не можна видалити останній активний товар.",w();return}if(window.confirm(`Видалити коробку №${b.number}? Цю дію не можна скасувати.`)){if(L){k.deleteProduct(b.id).then(()=>{F(p.filter(_=>_.id!==b.id)),v(f.cart,W().filter(_=>_.productId!==b.id)),Q(),q=`Товар №${b.number} видалено.`,w()}).catch(_=>{q=H(_,"Не вдалося видалити товар."),w()});return}F(p.filter(_=>_.id!==b.id)),v(f.cart,W().filter(_=>_.productId!==b.id)),Q(),q=`Товар №${b.number} видалено.`,w()}return}const fe=e.closest("[data-delete-order]");if(fe?.dataset.deleteOrder){const p=Z().find(b=>b.id===fe.dataset.deleteOrder);if(!p)return;if(window.confirm(`Видалити заявку ${p.id} від ${p.customerName}? Цю дію не можна скасувати.`)){if(L){k.deleteOrder(p.id).then(()=>{v(f.orders,Z().filter(b=>b.id!==p.id)),q=`Заявку ${p.id} видалено.`,w()}).catch(b=>{q=H(b,"Не вдалося видалити заявку."),w()});return}v(f.orders,Z().filter(b=>b.id!==p.id)),q=`Заявку ${p.id} видалено.`,w()}return}const ge=e.closest("[data-product-filter]");if(ge?.dataset.productFilter){lt=ge.dataset.productFilter,w();return}const ae=e.closest("[data-admin-order-filter]");if(ae?.dataset.adminOrderFilter){Rt=ae.dataset.adminOrderFilter,document.querySelectorAll("[data-admin-order-filter]").forEach(p=>{p.classList.toggle("is-active",p===ae)}),Pt();return}if(e.closest("[data-export-backup]")){if(L){k.backup().then(p=>{xe(`toffipacks-server-backup-${new Date().toISOString().slice(0,10)}.json`,p)}).catch(p=>{q=H(p,"Не вдалося завантажити серверну копію."),w()});return}xe(`toffipacks-backup-${new Date().toISOString().slice(0,10)}.json`,Qa());return}if(e.closest("[data-export-products]")){Ba(`toffipacks-products-${new Date().toISOString().slice(0,10)}.csv`,Ra(),"text/csv;charset=utf-8");return}if(e.closest("[data-reset-products]")){if(window.confirm("Відновити початковий каталог? Усі ручні зміни товарів буде втрачено.")){if(L){k.resetProducts().then(p=>{F(p),Q(),q="Початковий каталог відновлено.",w()}).catch(p=>{q=H(p,"Не вдалося відновити каталог."),w()});return}F(Jt.map(p=>({...p,active:!0,updatedAt:new Date().toISOString()}))),Q(),q="Початковий каталог відновлено.",w()}return}if(e.closest("#admin-logout")){L&&k.logout().catch(()=>rt()),localStorage.removeItem(f.session),J(),j(),N(!1),window.location.hash="admin",w();return}});document.addEventListener("keydown",t=>{const e=t.target,a=document.querySelector("#support-panel");if(t.key==="Escape"&&a&&!a.hidden){t.preventDefault(),Ut();return}const n=e.closest("[data-support-topic]");if(n&&["ArrowDown","ArrowUp","Home","End"].includes(t.key)){t.preventDefault();const d=Array.from(document.querySelectorAll("[data-support-topic]")),m=d.indexOf(n);let h=m;t.key==="ArrowDown"&&(h=(m+1)%d.length),t.key==="ArrowUp"&&(h=(m-1+d.length)%d.length),t.key==="Home"&&(h=0),t.key==="End"&&(h=d.length-1),d[h]?.focus();return}const s=e.closest("[data-product-picker-trigger]");if(s){const d=s.closest("[data-product-picker]");if(d&&(t.key==="ArrowDown"||t.key==="ArrowUp")){t.preventDefault(),Ve(d,!0);return}if(d&&t.key==="Escape"&&d.classList.contains("is-open")){t.preventDefault(),ut(d,!0);return}}const i=e.closest("[data-product-picker-value]");if(i){const d=i.closest("[data-product-picker]"),m=Array.from(d?.querySelectorAll("[data-product-picker-value]")??[]),h=m.indexOf(i);if(t.key==="Escape"){t.preventDefault(),d&&ut(d,!0);return}if(t.key==="Tab"){d&&ut(d);return}if(!["ArrowDown","ArrowUp","Home","End"].includes(t.key)||!m.length)return;t.preventDefault();let $=h;t.key==="ArrowDown"&&($=(h+1)%m.length),t.key==="ArrowUp"&&($=(h-1+m.length)%m.length),t.key==="Home"&&($=0),t.key==="End"&&($=m.length-1),m[$]?.focus(),m[$]?.scrollIntoView({block:"nearest"});return}const r=e.closest("[data-order-status-trigger]");if(r&&(t.key==="ArrowDown"||t.key==="ArrowUp")){t.preventDefault();const d=r.closest("[data-order-status-control]");d?.querySelector(".order-status-control__menu")?.hidden&&r.click();const h=Array.from(d?.querySelectorAll("[data-order-status-option]")??[]),$=Math.max(0,h.findIndex(T=>T.getAttribute("aria-selected")==="true"));h[t.key==="ArrowUp"?Math.max(0,$-1):$]?.focus();return}const u=e.closest("[data-order-status-option]");if(u){const d=u.closest("[data-order-status-control]"),m=Array.from(d?.querySelectorAll("[data-order-status-option]")??[]),h=m.indexOf(u);if(t.key==="Escape"){t.preventDefault(),Bt(),d?.querySelector("[data-order-status-trigger]")?.focus();return}if(!["ArrowDown","ArrowUp","Home","End"].includes(t.key))return;t.preventDefault();let $=h;t.key==="ArrowDown"&&($=(h+1)%m.length),t.key==="ArrowUp"&&($=(h-1+m.length)%m.length),t.key==="Home"&&($=0),t.key==="End"&&($=m.length-1),m[$]?.focus();return}const o=e.closest("[data-admin-calendar]");if(o&&t.key==="Escape"){t.preventDefault(),Je(),o.querySelector("[data-calendar-trigger]")?.focus();return}const l=e.closest("[data-calendar-trigger]");if(l&&t.key==="ArrowDown"){t.preventDefault(),o?.querySelector(".admin-calendar__popover")?.hidden&&l.click(),(o?.querySelector("[data-calendar-date].is-selected")??o?.querySelector("[data-calendar-date].is-today")??o?.querySelector("[data-calendar-date]:not(.is-outside)"))?.focus();return}const g=e.closest("[data-calendar-date]");if(g&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(t.key)){t.preventDefault();const d=Array.from(o?.querySelectorAll("[data-calendar-date]")??[]),m=d.indexOf(g),h=t.key==="ArrowLeft"?-1:t.key==="ArrowRight"?1:t.key==="ArrowUp"?-7:7;d[m+h]?.focus()}});document.addEventListener("input",t=>{const e=t.target;if(e instanceof HTMLInputElement&&e.id==="modal-quantity-input"){pt(Number(e.value));return}if(e instanceof HTMLInputElement&&e.id==="admin-product-search"){le=e.value,Ha();return}if(e instanceof HTMLInputElement&&e.id==="admin-order-search"){ue=e.value,Pt();return}if(e instanceof HTMLInputElement&&e.id==="admin-client-search"){Ua(e.value);return}if(e instanceof HTMLInputElement&&e.name==="basePrice"&&e.closest("#admin-product-form")){const a=Number(e.value)||0,n={...$t(),basePrice:a},s=e.closest("form")?.querySelector(".admin-editor-price-preview"),i=s?.querySelector("strong"),r=s?.querySelector("small");i&&(i.textContent=y(D(n,1))),r&&(r.textContent=`опт: ${y(D(n,z))}`)}});document.addEventListener("submit",t=>{const e=t.target;e instanceof HTMLFormElement&&(e.id==="login-form"?(t.preventDefault(),_e(e)):e.id==="register-form"?(t.preventDefault(),ka(e)):e.id==="admin-login-form"?(t.preventDefault(),_e(e,!0)):e.id==="admin-product-form"?(t.preventDefault(),ja(e)):e.id==="profile-form"&&(t.preventDefault(),_a(e)))});document.addEventListener("change",t=>{const e=t.target;if(e instanceof HTMLInputElement&&e.matches("[data-import-products]")){Wa(e);return}if(e instanceof HTMLInputElement&&e.matches("[data-import-backup]")){Za(e);return}if(e instanceof HTMLTextAreaElement&&e.dataset.orderNote){const a=Z(),n=a.find(s=>s.id===e.dataset.orderNote);n&&(n.managerNote=e.value.trim(),v(f.orders,a),L&&k.updateOrder(n.id,{managerNote:n.managerNote}).then(s=>{v(f.orders,a.map(i=>i.id===s.id?s:i))}).catch(s=>{q=H(s,"Не вдалося зберегти нотатку менеджера."),w()}));return}if(e instanceof HTMLInputElement||e instanceof HTMLSelectElement){if(e instanceof HTMLInputElement&&e.dataset.cartQuantity){Qe(e.dataset.cartQuantity,Number(e.value));return}if(e instanceof HTMLInputElement&&e.dataset.partnerToggle){const a=K(),n=a.find(s=>s.id===e.dataset.partnerToggle);if(n){if(n.partner=e.checked,n.partner&&!Object.keys(n.productPrices??{}).length&&(n.productPrices=Object.fromEntries(O().map(s=>[s.id,Math.round((s.basePrice+Ct)*100)/100]))),n.partner&&it.add(n.id),v(f.accounts,a),L){k.updateClient(n.id,{partner:n.partner,productPrices:n.productPrices}).then(s=>{v(f.accounts,a.map(i=>i.id===s.id?s:i)),w()}).catch(s=>{q=H(s,"Не вдалося змінити статус клієнта."),w()});return}w()}return}if(e instanceof HTMLInputElement&&e.dataset.clientProductPrice&&e.dataset.clientId){const a=K(),n=a.find(s=>s.id===e.dataset.clientId);if(n){const s=e.value.trim(),i=Number(s);if(s&&(!Number.isFinite(i)||i<.01||i>1e4)){e.setCustomValidity("Вкажіть кінцеву ціну від 0,01 до 10 000 грн."),e.reportValidity();return}e.setCustomValidity(""),n.productPrices={...n.productPrices??{}},s?n.productPrices[e.dataset.clientProductPrice]=Math.round(i*100)/100:delete n.productPrices[e.dataset.clientProductPrice],it.add(n.id),v(f.accounts,a);const r=O().filter(l=>Number(n.productPrices?.[l.id])>0).length,u=document.querySelector(`[data-client-prices-toggle="${CSS.escape(n.id)}"] strong`);u&&(u.textContent=`${r} із ${O().length}`);const o=e.closest(".client-product-price");if(o?.classList.remove("is-saved"),o&&(o.offsetWidth,o.classList.add("is-saved"),window.setTimeout(()=>o.classList.remove("is-saved"),900)),L){k.updateClient(n.id,{productPrices:n.productPrices}).then(l=>{v(f.accounts,a.map(g=>g.id===l.id?l:g))}).catch(l=>{q=H(l,"Не вдалося зберегти персональну ціну."),w()});return}}}}});document.querySelector("#product-dialog")?.addEventListener("click",t=>{t.target===t.currentTarget&&xt()});document.querySelector("#product-dialog")?.addEventListener("cancel",t=>{t.preventDefault(),xt()});document.querySelector("#admin-product-dialog")?.addEventListener("click",t=>{t.target===t.currentTarget&&t.currentTarget.close()});document.querySelector("#profile-dialog")?.addEventListener("click",t=>{t.target===t.currentTarget&&t.currentTarget.close()});window.addEventListener("hashchange",Xt);async function Ga(){if(L){document.body.dataset.backend="loading";try{F(await k.products()),ft()&&await Qt(),document.body.dataset.backend="online",Q(),J(),Xt()}catch(t){document.body.dataset.backend="offline",console.error("ToffiPacks backend is unavailable:",t),window.location.hash.startsWith("#admin")&&(q="Сервер тимчасово недоступний. Дані не змінено.",w())}}}function de(){J(),N(!1),j(),B()}async function Ye(){if(!(!L||!ft()||V()?.role!=="client"))try{Nt(await k.me()),de()}catch(t){t instanceof Tt&&t.status===401&&(rt(),localStorage.removeItem(f.session),de())}}window.addEventListener("storage",t=>{t.key===f.accounts&&V()?.role==="client"&&de()});window.addEventListener("focus",()=>{Ye()});window.setInterval(()=>{document.visibilityState==="visible"&&Ye()},2e4);N(!0);window.setTimeout(()=>N(!1),460);j();J();Xt();Ya();Ga();"serviceWorker"in navigator&&window.location.protocol==="https:"&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").catch(()=>{})});
